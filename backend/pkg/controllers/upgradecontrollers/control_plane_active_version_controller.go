...
func (c *controlPlaneActiveVersionSyncer) SyncOnce(ctx context.Context, key controllerutils.HCPClusterKey) error {
	...
	desiredServiceProviderCluster := cachedServiceProviderCluster.DeepCopy()
	desiredServiceProviderCluster.Status.ControlPlaneVersion.ActiveVersions = newActiveVersions
	...
	_, err = serviceProviderClustersCosmosClient.Replace(ctx, desiredServiceProviderCluster, nil)
	if err != nil {
