...
const NodePoolRequirementsValidAggregatorControllerName = nodePoolRequirementsValidAggregatorControllerName
...
func (c *nodePoolRequirementsValidAggregator) SyncOnce(ctx context.Context, key controllerutils.HCPNodePoolKey) error {
	...
	aggregated := statusutils.AggregateRequirementsValidCondition(serviceProviderNodePool.Status.Validations)
