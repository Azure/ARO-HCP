...
import (
	...
	"github.com/Azure/ARO-HCP/backend/pkg/controllers/shared/validation"
...
// mockNodePoolValidation implements validation.NodePoolValidation for tests.
type mockNodePoolValidation struct {
	name        string
	validateErr error
}

var _ validation.NodePoolValidation = (*mockNodePoolValidation)(nil)
