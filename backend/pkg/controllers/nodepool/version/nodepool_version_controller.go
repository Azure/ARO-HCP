...
// NeedsWork.
func (c *nodePoolVersionSyncer) NeedsWork(nodePool *coreapi.NodePool, serviceProviderNodePool *coreapi.ServiceProviderNodePool, serviceProviderCluster *coreapi.ServiceProviderCluster) bool {
