...
func TestControlPlaneActiveVersionSyncer_SyncOnce_ReadsClusterFromCache(t *testing.T) {
	...
	spcID := metadataapi.Must(azcorearm.ParseResourceID(coreapihelpers.ToServiceProviderClusterResourceIDString(testSubscriptionID, testResourceGroupName, testClusterName)))
