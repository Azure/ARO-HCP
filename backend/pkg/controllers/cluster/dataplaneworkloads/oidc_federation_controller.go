...
func (s *dataPlaneOIDCFederationSyncer) ensureFederation(
	...
	// DataPlaneOIDCFederationIntent drops it from the desired set), cluster
	// deletion, and ClientID / PrincipalID / TenantID rotation (old key). This
	// loop runs while the identity stays Configured because it is still in
	// DataPlaneOperators.
	//
