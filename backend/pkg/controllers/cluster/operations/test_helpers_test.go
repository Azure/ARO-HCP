...
// nodePoolTestFixture is used by tests that need a node pool under the test cluster.
...
// externalAuthTestFixture is used by tests that need an external auth under the test cluster.
