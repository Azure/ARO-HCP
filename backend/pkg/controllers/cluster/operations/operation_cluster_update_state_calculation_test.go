	...
	tests := []struct {
			...
			cluster: &coreapi.HCPOpenShiftCluster{
				CustomerProperties: coreapi.HCPOpenShiftClusterCustomerProperties{
					Platform: coreapi.CustomerPlatformProfile{
						ContainerRegistryPullManagedIdentity: coreapitesting.NewTestUserAssignedIdentity("cr-pull-mi"),
					},
				},
			},
		...
		},
		{
			...
			cluster: &coreapi.HCPOpenShiftCluster{
				CustomerProperties: coreapi.HCPOpenShiftClusterCustomerProperties{
					Platform: coreapi.CustomerPlatformProfile{
						ContainerRegistryPullManagedIdentity: coreapitesting.NewTestUserAssignedIdentity("new-mi"),
					},
				},
			},
			csCluster: func() *arohcpv1alpha1.Cluster {
