...
func (c *operationClusterUpdate) determineOperationState(ctx context.Context, operation *api.Operation) (*sharedops.OperationState, error) {
	logger := utils.LoggerFromContext(ctx)
	errs := []error{}
...
func (c *operationClusterUpdate) desiredVersionResolutionOperationState(ctx context.Context, operation *api.Operation) (*sharedops.OperationState, error) {
...
func (c *operationClusterUpdate) clusterServiceUpdateOperationState(ctx context.Context, operation *api.Operation) (*sharedops.OperationState, error) {
	logger := utils.LoggerFromContext(ctx)
