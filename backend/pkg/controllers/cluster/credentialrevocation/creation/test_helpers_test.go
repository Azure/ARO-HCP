...
func createTestRevocation(t *testing.T, db *corecosmosstoragetesting.MockResourcesDBClient, revocationName string, opts ...func(*api.SystemAdminCredentialRevocation)) *api.SystemAdminCredentialRevocation {
	t.Helper()
...
func createTestCluster(t *testing.T, db *corecosmosstoragetesting.MockResourcesDBClient, opts ...func(*api.HCPOpenShiftCluster)) *api.HCPOpenShiftCluster {
	t.Helper()
