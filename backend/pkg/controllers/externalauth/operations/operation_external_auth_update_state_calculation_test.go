...
func TestHypershiftHostedClusterExternalAuthOperationState(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			externalAuth: operationtesting.NewExternalAuthUpdateTestExternalAuth(func(ea *coreapi.ExternalAuth) {
...
func TestClusterServiceExternalAuthSpecOperationState(t *testing.T) {
	...
	newCSExternalAuthFromRP := func(t *testing.T, externalAuth *coreapi.ExternalAuth) *arohcpv1alpha1.ExternalAuth {
		t.Helper()
