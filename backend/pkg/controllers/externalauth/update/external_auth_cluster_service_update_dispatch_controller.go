...
func needsWork(ea *coreapi.ClusterExternalAuth) bool {
...
func (c *externalAuthClusterServiceUpdateDispatchSyncer) marshalClusterServiceExternalAuthUpdatePayload(ctx context.Context, externalAuth *coreapi.ClusterExternalAuth) (string, error) {
