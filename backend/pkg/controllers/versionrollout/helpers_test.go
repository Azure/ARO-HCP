...
func newTestCluster(name, channelGroup, versionID string) *coreapi.Cluster {
...
func newTestServiceProviderCluster(clusterName string, desired *semver.Version, active []coreapi.ServiceProviderClusterActiveVersion, pinned *coreapi.ServiceProviderClusterPinnedVersion) *coreapi.ServiceProviderCluster {
