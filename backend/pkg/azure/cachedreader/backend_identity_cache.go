...
type BackendIdentityAzureCache struct {
	// RoleDefinitionsCache is the client used to get Azure RBAC role definitions
	// (e.g. for resolving role definition IDs to allowed actions).
	RoleDefinitionsCache CachedRoleDefinitions
}
