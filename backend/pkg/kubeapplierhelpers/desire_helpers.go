...
func (p DesireParent) applyDesireCRUD(client kubeappliercosmosstorage.KubeApplierDBClient, subscriptionID, resourceGroupName, clusterName string) (cosmosstorageutils.ResourceCRUD[kubeapplier.ApplyDesire, *kubeapplier.ApplyDesire], error) {
	switch {
...
func (p DesireParent) readDesireCRUD(client kubeappliercosmosstorage.KubeApplierDBClient, subscriptionID, resourceGroupName, clusterName string) (cosmosstorageutils.ResourceCRUD[kubeapplier.ReadDesire, *kubeapplier.ReadDesire], error) {
	switch {
	case p.credentialRequestName != "":
...
func (p DesireParent) applyDesireResourceIDString(subscriptionID, resourceGroupName, clusterName, desireName string) string {
	switch {
	case p.credentialRequestName != "":
		return kubeapplier.ToSystemAdminCredentialRequestScopedApplyDesireResourceIDString(subscriptionID, resourceGroupName, clusterName, p.credentialRequestName, desireName)
	case p.revocationName != "":
		return kubeapplier.ToSystemAdminCredentialRevocationScopedApplyDesireResourceIDString(subscriptionID, resourceGroupName, clusterName, p.revocationName, desireName)
	default:
...
func (p DesireParent) readDesireResourceIDString(subscriptionID, resourceGroupName, clusterName, desireName string) string {
	switch {
	case p.credentialRequestName != "":
		return kubeapplier.ToSystemAdminCredentialRequestScopedReadDesireResourceIDString(subscriptionID, resourceGroupName, clusterName, p.credentialRequestName, desireName)
	case p.revocationName != "":
		return kubeapplier.ToSystemAdminCredentialRevocationScopedReadDesireResourceIDString(subscriptionID, resourceGroupName, clusterName, p.revocationName, desireName)
	default:
...
func EnsureApplyDesire(
	ctx context.Context,
	crud cosmosstorageutils.ResourceCRUD[kubeapplier.ApplyDesire, *kubeapplier.ApplyDesire],
...
func EnsureReadDesire(
	ctx context.Context,
	crud cosmosstorageutils.ResourceCRUD[kubeapplier.ReadDesire, *kubeapplier.ReadDesire],
