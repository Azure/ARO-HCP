...
// GetCachedCertificateRevocationRequestForSystemAdminCredentialRevocation reads the CRR mirror from
// the revocation-scoped ReadDesire. The ReadDesire's Status.KubeContent.Raw
