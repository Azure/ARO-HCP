...
func (c *ChangeFeedWatcher[InternalAPIType, InternalAPITypePointer, CosmosAPIType]) Run(ctx context.Context) {
	...
	for _, feedRange := range resourcesFeedRanges {
		...
		go wait.UntilWithContext(localCtx, c.runReadFeedRangeFn(localFeedRange), feedRangePollInterval)
	}
...
//}
//
//func NewCosmosDBListWatch(cosmosClient database.ResourcesDBClient) *CosmosDBListWatch {
//	c := &CosmosDBListWatch{
...
//
//			iter, err := c.cosmosClient.ResourcesGlobalListers().Subscriptions().List(ctx, nil)
//			if err != nil {
//				return nil, err
//			}
//
...
//			defer logger.Info("finished listing clusters")
//
//			iter, err := c.cosmosClient.ResourcesGlobalListers().Clusters().List(ctx, nil)
//			if err != nil {
//				return nil, err
//			}
//
...
//
//			iter, err := c.cosmosClient.ResourcesGlobalListers().NodePools().List(ctx, nil)
//			if err != nil {
//				return nil, err
//			}
//
...
//
//			iter, err := c.cosmosClient.ResourcesGlobalListers().ExternalAuths().List(ctx, nil)
//			if err != nil {
//				return nil, err
//			}
//
...
//
//			iter, err := c.cosmosClient.ResourcesGlobalListers().ServiceProviderClusters().List(ctx, nil)
//			if err != nil {
//				return nil, err
//			}
//
...
//
//			iter, err := c.cosmosClient.ResourcesGlobalListers().ActiveOperations().List(ctx, nil)
//			if err != nil {
//				return nil, err
//			}
//
...
//	var clusterDocument database.GenericDocument[api.HCPOpenShiftCluster]
//
...
//	}
//
//	cluster, err := database.CosmosToInternal[api.HCPOpenShiftCluster, database.GenericDocument[api.HCPOpenShiftCluster]](&clusterDocument)
//	if err != nil {
//		return err
//	}
//
...
//	var nodePoolDocument database.GenericDocument[api.HCPOpenShiftClusterNodePool]
//
...
//	}
//
//	nodePool, err := database.CosmosToInternal[api.HCPOpenShiftClusterNodePool, database.GenericDocument[api.HCPOpenShiftClusterNodePool]](&nodePoolDocument)
//	if err != nil {
//		return err
//	}
//
...
//	var externalAuthDocument database.GenericDocument[api.HCPOpenShiftClusterExternalAuth]
//
...
//	}
//
//	externalAuth, err := database.CosmosToInternal[api.HCPOpenShiftClusterExternalAuth, database.GenericDocument[api.HCPOpenShiftClusterExternalAuth]](&externalAuthDocument)
//	if err != nil {
//		return err
//	}
//
