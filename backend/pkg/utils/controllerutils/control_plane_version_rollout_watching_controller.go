...
// resource name. All rollouts share a Cosmos partition keyed by the provider namespace.
...
func (k ControlPlaneVersionRolloutKey) GetResourceID() *azcorearm.ResourceID {
	return metadataapi.Must(fleetapihelpers.ToControlPlaneVersionRolloutResourceID(k.YStreamChannel))
}
