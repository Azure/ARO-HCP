...
func (v *AzureNodePoolVMQuotaValidation) Validate(ctx context.Context, _ *coreapi.Cluster, nodePoolSubscription *coreapi.Subscription, nodePool *coreapi.ClusterNodePool) ValidationResult {
...
func (v *AzureNodePoolVMQuotaValidation) requiredInstanceCount(nodePool *coreapi.ClusterNodePool) int32 {
	if nodePool.Properties.AutoScaling != nil {
