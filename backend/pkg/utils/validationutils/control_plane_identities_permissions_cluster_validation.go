...
func (v *ControlPlaneIdentitiesPermissionsClusterValidation) Validate(ctx context.Context, clusterSubscription *arm.Subscription, cluster *api.HCPOpenShiftCluster) ValidationResult {
	...
	return PassedValidation(
		api.ControllerConditionReasonAsExpected,
		"Control plane operators have all required permissions.",
		"Control plane operators have all required permissions.",
	)
}
