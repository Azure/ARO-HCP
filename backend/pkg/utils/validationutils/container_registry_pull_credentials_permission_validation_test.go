...
func testCluster(containerRegistryMIResourceID, capzResourceID string) *coreapi.HCPOpenShiftCluster {
...
func TestContainerRegistryPullCredentialsPermissionValidation(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			cluster: testCluster("", capzMIResourceID),
		...
		},
		{
			...
			cluster: testCluster(containerRegistryPullMIResourceID, capzMIResourceID),
...
func TestContainerRegistryPullCredentialsPermissionValidation_InputKey(t *testing.T) {
	...
	t.Run("returns MI resource ID string", func(t *testing.T) {
		cluster := testCluster(miA, capzResourceID)
	...
	t.Run("different MIs return different keys", func(t *testing.T) {
		clusterA := testCluster(miA, capzResourceID)
		clusterB := testCluster(miB, capzResourceID)
