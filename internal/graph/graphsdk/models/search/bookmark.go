...
func (m *Bookmark) GetFieldDeserializers() map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
	...
	res["platforms"] = func(n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
		val, err := n.GetCollectionOfEnumValues(i1064077c0deed3e13037469d51458ffc82d2db75e239cd9605f39aaa91186035.ParseDevicePlatformType)
		if err != nil {
			return err
		}
		if val != nil {
			res := make([]i1064077c0deed3e13037469d51458ffc82d2db75e239cd9605f39aaa91186035.DevicePlatformType, len(val))
			for i, v := range val {
				if v != nil {
					res[i] = *(v.(*i1064077c0deed3e13037469d51458ffc82d2db75e239cd9605f39aaa91186035.DevicePlatformType))
				}
			}
			m.SetPlatforms(res)
		}
...
func (m *Bookmark) GetPlatforms() []i1064077c0deed3e13037469d51458ffc82d2db75e239cd9605f39aaa91186035.DevicePlatformType {
...
func (m *Bookmark) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter) error {
	...
	if m.GetPlatforms() != nil {
		err = writer.WriteCollectionOfStringValues("platforms", i1064077c0deed3e13037469d51458ffc82d2db75e239cd9605f39aaa91186035.SerializeDevicePlatformType(m.GetPlatforms()))
		if err != nil {
			return err
		}
	}
...
func (m *Bookmark) SetPlatforms(value []i1064077c0deed3e13037469d51458ffc82d2db75e239cd9605f39aaa91186035.DevicePlatformType) {
...
type Bookmarkable interface {
	...
	GetPlatforms() []i1064077c0deed3e13037469d51458ffc82d2db75e239cd9605f39aaa91186035.DevicePlatformType
	...
	SetPlatforms(value []i1064077c0deed3e13037469d51458ffc82d2db75e239cd9605f39aaa91186035.DevicePlatformType)
