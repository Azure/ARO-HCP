...
func (m *Term) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
    ...
    res["properties"] = func (n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
        val, err := n.GetCollectionOfObjectValues(i1064077c0deed3e13037469d51458ffc82d2db75e239cd9605f39aaa91186035.CreateKeyValueFromDiscriminatorValue)
        if err != nil {
            return err
        }
        if val != nil {
            res := make([]i1064077c0deed3e13037469d51458ffc82d2db75e239cd9605f39aaa91186035.KeyValueable, len(val))
            for i, v := range val {
                if v != nil {
                    res[i] = v.(i1064077c0deed3e13037469d51458ffc82d2db75e239cd9605f39aaa91186035.KeyValueable)
                }
            }
            m.SetProperties(res)
        }
...
func (m *Term) GetProperties()([]i1064077c0deed3e13037469d51458ffc82d2db75e239cd9605f39aaa91186035.KeyValueable) {
    val, err := m.GetBackingStore().Get("properties")
    if err != nil {
        panic(err)
    }
    if val != nil {
        return val.([]i1064077c0deed3e13037469d51458ffc82d2db75e239cd9605f39aaa91186035.KeyValueable)
    }
    return nil
}
...
func (m *Term) SetProperties(value []i1064077c0deed3e13037469d51458ffc82d2db75e239cd9605f39aaa91186035.KeyValueable)() {
...
type Termable interface {
    ...
    GetProperties()([]i1064077c0deed3e13037469d51458ffc82d2db75e239cd9605f39aaa91186035.KeyValueable)
    ...
    SetProperties(value []i1064077c0deed3e13037469d51458ffc82d2db75e239cd9605f39aaa91186035.KeyValueable)()
