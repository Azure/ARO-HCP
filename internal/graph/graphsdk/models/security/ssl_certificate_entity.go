...
func (m *SslCertificateEntity) GetAddress()(i1064077c0deed3e13037469d51458ffc82d2db75e239cd9605f39aaa91186035.PhysicalAddressable) {
    val, err := m.GetBackingStore().Get("address")
    if err != nil {
        panic(err)
    }
    if val != nil {
        return val.(i1064077c0deed3e13037469d51458ffc82d2db75e239cd9605f39aaa91186035.PhysicalAddressable)
    }
    return nil
}
...
func (m *SslCertificateEntity) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
    ...
    res["address"] = func (n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
        val, err := n.GetObjectValue(i1064077c0deed3e13037469d51458ffc82d2db75e239cd9605f39aaa91186035.CreatePhysicalAddressFromDiscriminatorValue)
        if err != nil {
            return err
        }
        if val != nil {
            m.SetAddress(val.(i1064077c0deed3e13037469d51458ffc82d2db75e239cd9605f39aaa91186035.PhysicalAddressable))
        }
        return nil
    }
...
func (m *SslCertificateEntity) SetAddress(value i1064077c0deed3e13037469d51458ffc82d2db75e239cd9605f39aaa91186035.PhysicalAddressable)() {
...
type SslCertificateEntityable interface {
    ...
    GetAddress()(i1064077c0deed3e13037469d51458ffc82d2db75e239cd9605f39aaa91186035.PhysicalAddressable)
    ...
    GetSurname()(*string)
    SetAddress(value i1064077c0deed3e13037469d51458ffc82d2db75e239cd9605f39aaa91186035.PhysicalAddressable)()
