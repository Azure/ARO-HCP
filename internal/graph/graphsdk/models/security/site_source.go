...
func (m *SiteSource) GetFieldDeserializers() map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
	...
	res["site"] = func(n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
		val, err := n.GetObjectValue(i1064077c0deed3e13037469d51458ffc82d2db75e239cd9605f39aaa91186035.CreateSiteFromDiscriminatorValue)
		if err != nil {
			return err
		}
		if val != nil {
			m.SetSite(val.(i1064077c0deed3e13037469d51458ffc82d2db75e239cd9605f39aaa91186035.Siteable))
		}
		return nil
	}
	return res
...
func (m *SiteSource) GetSite() i1064077c0deed3e13037469d51458ffc82d2db75e239cd9605f39aaa91186035.Siteable {
	val, err := m.GetBackingStore().Get("site")
	if err != nil {
		panic(err)
	}
	if val != nil {
		return val.(i1064077c0deed3e13037469d51458ffc82d2db75e239cd9605f39aaa91186035.Siteable)
	}
	return nil
}
...
func (m *SiteSource) SetSite(value i1064077c0deed3e13037469d51458ffc82d2db75e239cd9605f39aaa91186035.Siteable) {
...
type SiteSourceable interface {
	...
	GetSite() i1064077c0deed3e13037469d51458ffc82d2db75e239cd9605f39aaa91186035.Siteable
	SetSite(value i1064077c0deed3e13037469d51458ffc82d2db75e239cd9605f39aaa91186035.Siteable)
}
