...
func (m *LifecycleWorkflowsContainer) GetDeletedItems() i1064077c0deed3e13037469d51458ffc82d2db75e239cd9605f39aaa91186035.DeletedItemContainerable {
	val, err := m.GetBackingStore().Get("deletedItems")
	if err != nil {
		panic(err)
	}
	if val != nil {
		return val.(i1064077c0deed3e13037469d51458ffc82d2db75e239cd9605f39aaa91186035.DeletedItemContainerable)
	}
	return nil
}
...
func (m *LifecycleWorkflowsContainer) GetFieldDeserializers() map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
	...
	res["deletedItems"] = func(n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
		val, err := n.GetObjectValue(i1064077c0deed3e13037469d51458ffc82d2db75e239cd9605f39aaa91186035.CreateDeletedItemContainerFromDiscriminatorValue)
		if err != nil {
			return err
		}
		if val != nil {
			m.SetDeletedItems(val.(i1064077c0deed3e13037469d51458ffc82d2db75e239cd9605f39aaa91186035.DeletedItemContainerable))
		}
		return nil
	}
...
func (m *LifecycleWorkflowsContainer) SetDeletedItems(value i1064077c0deed3e13037469d51458ffc82d2db75e239cd9605f39aaa91186035.DeletedItemContainerable) {
...
type LifecycleWorkflowsContainerable interface {
	...
	GetDeletedItems() i1064077c0deed3e13037469d51458ffc82d2db75e239cd9605f39aaa91186035.DeletedItemContainerable
	...
	SetDeletedItems(value i1064077c0deed3e13037469d51458ffc82d2db75e239cd9605f39aaa91186035.DeletedItemContainerable)
