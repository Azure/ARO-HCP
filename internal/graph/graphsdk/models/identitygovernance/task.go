...
func (m *Task) GetArguments()([]i1064077c0deed3e13037469d51458ffc82d2db75e239cd9605f39aaa91186035.KeyValuePairable) {
    val, err := m.GetBackingStore().Get("arguments")
    if err != nil {
        panic(err)
    }
    if val != nil {
        return val.([]i1064077c0deed3e13037469d51458ffc82d2db75e239cd9605f39aaa91186035.KeyValuePairable)
    }
    return nil
}
...
func (m *Task) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
    ...
    res["arguments"] = func (n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
        val, err := n.GetCollectionOfObjectValues(i1064077c0deed3e13037469d51458ffc82d2db75e239cd9605f39aaa91186035.CreateKeyValuePairFromDiscriminatorValue)
        if err != nil {
            return err
        }
        if val != nil {
            res := make([]i1064077c0deed3e13037469d51458ffc82d2db75e239cd9605f39aaa91186035.KeyValuePairable, len(val))
            for i, v := range val {
                if v != nil {
                    res[i] = v.(i1064077c0deed3e13037469d51458ffc82d2db75e239cd9605f39aaa91186035.KeyValuePairable)
                }
            }
            m.SetArguments(res)
        }
...
func (m *Task) SetArguments(value []i1064077c0deed3e13037469d51458ffc82d2db75e239cd9605f39aaa91186035.KeyValuePairable)() {
...
type Taskable interface {
    ...
    GetArguments()([]i1064077c0deed3e13037469d51458ffc82d2db75e239cd9605f39aaa91186035.KeyValuePairable)
    ...
    SetArguments(value []i1064077c0deed3e13037469d51458ffc82d2db75e239cd9605f39aaa91186035.KeyValuePairable)()
