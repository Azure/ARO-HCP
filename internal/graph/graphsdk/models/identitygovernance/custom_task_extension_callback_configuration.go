...
type CustomTaskExtensionCallbackConfiguration struct {
	i1064077c0deed3e13037469d51458ffc82d2db75e239cd9605f39aaa91186035.CustomExtensionCallbackConfiguration
}
...
func NewCustomTaskExtensionCallbackConfiguration() *CustomTaskExtensionCallbackConfiguration {
	m := &CustomTaskExtensionCallbackConfiguration{
		CustomExtensionCallbackConfiguration: *i1064077c0deed3e13037469d51458ffc82d2db75e239cd9605f39aaa91186035.NewCustomExtensionCallbackConfiguration(),
	}
...
func (m *CustomTaskExtensionCallbackConfiguration) GetAuthorizedApps() []i1064077c0deed3e13037469d51458ffc82d2db75e239cd9605f39aaa91186035.Applicationable {
	val, err := m.GetBackingStore().Get("authorizedApps")
	if err != nil {
		panic(err)
	}
	if val != nil {
		return val.([]i1064077c0deed3e13037469d51458ffc82d2db75e239cd9605f39aaa91186035.Applicationable)
	}
	return nil
}
...
func (m *CustomTaskExtensionCallbackConfiguration) GetFieldDeserializers() map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
	...
	res["authorizedApps"] = func(n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
		val, err := n.GetCollectionOfObjectValues(i1064077c0deed3e13037469d51458ffc82d2db75e239cd9605f39aaa91186035.CreateApplicationFromDiscriminatorValue)
		if err != nil {
			return err
		}
		if val != nil {
			res := make([]i1064077c0deed3e13037469d51458ffc82d2db75e239cd9605f39aaa91186035.Applicationable, len(val))
			for i, v := range val {
				if v != nil {
					res[i] = v.(i1064077c0deed3e13037469d51458ffc82d2db75e239cd9605f39aaa91186035.Applicationable)
				}
			}
...
func (m *CustomTaskExtensionCallbackConfiguration) SetAuthorizedApps(value []i1064077c0deed3e13037469d51458ffc82d2db75e239cd9605f39aaa91186035.Applicationable) {
...
type CustomTaskExtensionCallbackConfigurationable interface {
	i1064077c0deed3e13037469d51458ffc82d2db75e239cd9605f39aaa91186035.CustomExtensionCallbackConfigurationable
	i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable
	GetAuthorizedApps() []i1064077c0deed3e13037469d51458ffc82d2db75e239cd9605f39aaa91186035.Applicationable
	SetAuthorizedApps(value []i1064077c0deed3e13037469d51458ffc82d2db75e239cd9605f39aaa91186035.Applicationable)
}
