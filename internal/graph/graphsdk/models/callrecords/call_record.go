...
func (m *CallRecord) GetFieldDeserializers() map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
	...
	res["organizer"] = func(n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
		...
		if val != nil {
			m.SetOrganizer(val.(i1064077c0deed3e13037469d51458ffc82d2db75e239cd9605f39aaa91186035.IdentitySetable))
		}
		return nil
	}
	...
	res["participants"] = func(n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
		val, err := n.GetCollectionOfObjectValues(i1064077c0deed3e13037469d51458ffc82d2db75e239cd9605f39aaa91186035.CreateIdentitySetFromDiscriminatorValue)
		if err != nil {
			return err
		}
		if val != nil {
			res := make([]i1064077c0deed3e13037469d51458ffc82d2db75e239cd9605f39aaa91186035.IdentitySetable, len(val))
			for i, v := range val {
				if v != nil {
					res[i] = v.(i1064077c0deed3e13037469d51458ffc82d2db75e239cd9605f39aaa91186035.IdentitySetable)
				}
			}
...
func (m *CallRecord) GetOrganizer() i1064077c0deed3e13037469d51458ffc82d2db75e239cd9605f39aaa91186035.IdentitySetable {
...
// returns a []IdentitySetable when successful
func (m *CallRecord) GetParticipants() []i1064077c0deed3e13037469d51458ffc82d2db75e239cd9605f39aaa91186035.IdentitySetable {
...
func (m *CallRecord) SetOrganizer(value i1064077c0deed3e13037469d51458ffc82d2db75e239cd9605f39aaa91186035.IdentitySetable) {
...
func (m *CallRecord) SetParticipants(value []i1064077c0deed3e13037469d51458ffc82d2db75e239cd9605f39aaa91186035.IdentitySetable) {
...
type CallRecordable interface {
	...
	GetOrganizer() i1064077c0deed3e13037469d51458ffc82d2db75e239cd9605f39aaa91186035.IdentitySetable
	GetOrganizerV2() Organizerable
	GetParticipants() []i1064077c0deed3e13037469d51458ffc82d2db75e239cd9605f39aaa91186035.IdentitySetable
	...
	SetOrganizer(value i1064077c0deed3e13037469d51458ffc82d2db75e239cd9605f39aaa91186035.IdentitySetable)
	SetOrganizerV2(value Organizerable)
	SetParticipants(value []i1064077c0deed3e13037469d51458ffc82d2db75e239cd9605f39aaa91186035.IdentitySetable)
