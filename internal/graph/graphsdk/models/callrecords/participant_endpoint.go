...
func (m *ParticipantEndpoint) GetAssociatedIdentity() i1064077c0deed3e13037469d51458ffc82d2db75e239cd9605f39aaa91186035.Identityable {
	val, err := m.GetBackingStore().Get("associatedIdentity")
	if err != nil {
		panic(err)
	}
	if val != nil {
		return val.(i1064077c0deed3e13037469d51458ffc82d2db75e239cd9605f39aaa91186035.Identityable)
	}
	return nil
}
...
func (m *ParticipantEndpoint) GetFieldDeserializers() map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
	...
	res["associatedIdentity"] = func(n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
		val, err := n.GetObjectValue(i1064077c0deed3e13037469d51458ffc82d2db75e239cd9605f39aaa91186035.CreateIdentityFromDiscriminatorValue)
		if err != nil {
			return err
		}
		if val != nil {
			m.SetAssociatedIdentity(val.(i1064077c0deed3e13037469d51458ffc82d2db75e239cd9605f39aaa91186035.Identityable))
		}
		return nil
	}
	...
	res["identity"] = func(n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
		val, err := n.GetObjectValue(i1064077c0deed3e13037469d51458ffc82d2db75e239cd9605f39aaa91186035.CreateIdentitySetFromDiscriminatorValue)
		if err != nil {
			return err
		}
		if val != nil {
			m.SetIdentity(val.(i1064077c0deed3e13037469d51458ffc82d2db75e239cd9605f39aaa91186035.IdentitySetable))
		}
		return nil
	}
...
func (m *ParticipantEndpoint) GetIdentity() i1064077c0deed3e13037469d51458ffc82d2db75e239cd9605f39aaa91186035.IdentitySetable {
	val, err := m.GetBackingStore().Get("identity")
	if err != nil {
		panic(err)
	}
	if val != nil {
		return val.(i1064077c0deed3e13037469d51458ffc82d2db75e239cd9605f39aaa91186035.IdentitySetable)
	}
	return nil
}
...
func (m *ParticipantEndpoint) SetAssociatedIdentity(value i1064077c0deed3e13037469d51458ffc82d2db75e239cd9605f39aaa91186035.Identityable) {
...
func (m *ParticipantEndpoint) SetIdentity(value i1064077c0deed3e13037469d51458ffc82d2db75e239cd9605f39aaa91186035.IdentitySetable) {
...
type ParticipantEndpointable interface {
	...
	GetAssociatedIdentity() i1064077c0deed3e13037469d51458ffc82d2db75e239cd9605f39aaa91186035.Identityable
	GetCpuCoresCount() *int32
	GetCpuName() *string
	GetCpuProcessorSpeedInMhz() *int32
	GetFeedback() UserFeedbackable
	GetIdentity() i1064077c0deed3e13037469d51458ffc82d2db75e239cd9605f39aaa91186035.IdentitySetable
	GetName() *string
	SetAssociatedIdentity(value i1064077c0deed3e13037469d51458ffc82d2db75e239cd9605f39aaa91186035.Identityable)
	...
	SetIdentity(value i1064077c0deed3e13037469d51458ffc82d2db75e239cd9605f39aaa91186035.IdentitySetable)
