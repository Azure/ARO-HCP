...
func (m *ParticipantBase) GetFieldDeserializers() map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
	...
	res["identity"] = func(n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
		val, err := n.GetObjectValue(i1064077c0deed3e13037469d51458ffc82d2db75e239cd9605f39aaa91186035.CreateCommunicationsIdentitySetFromDiscriminatorValue)
		if err != nil {
			return err
		}
		if val != nil {
			m.SetIdentity(val.(i1064077c0deed3e13037469d51458ffc82d2db75e239cd9605f39aaa91186035.CommunicationsIdentitySetable))
		}
		return nil
	}
	return res
...
func (m *ParticipantBase) GetIdentity() i1064077c0deed3e13037469d51458ffc82d2db75e239cd9605f39aaa91186035.CommunicationsIdentitySetable {
	val, err := m.GetBackingStore().Get("identity")
	if err != nil {
		panic(err)
	}
	if val != nil {
		return val.(i1064077c0deed3e13037469d51458ffc82d2db75e239cd9605f39aaa91186035.CommunicationsIdentitySetable)
	}
	return nil
}
...
func (m *ParticipantBase) SetIdentity(value i1064077c0deed3e13037469d51458ffc82d2db75e239cd9605f39aaa91186035.CommunicationsIdentitySetable) {
...
type ParticipantBaseable interface {
	...
	GetIdentity() i1064077c0deed3e13037469d51458ffc82d2db75e239cd9605f39aaa91186035.CommunicationsIdentitySetable
	SetAdministrativeUnitInfos(value []AdministrativeUnitInfoable)
	SetIdentity(value i1064077c0deed3e13037469d51458ffc82d2db75e239cd9605f39aaa91186035.CommunicationsIdentitySetable)
}
