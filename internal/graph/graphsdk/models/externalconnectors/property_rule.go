...
func (m *PropertyRule) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
    ...
    res["valuesJoinedBy"] = func (n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
        val, err := n.GetEnumValue(i1064077c0deed3e13037469d51458ffc82d2db75e239cd9605f39aaa91186035.ParseBinaryOperator)
        if err != nil {
            return err
        }
        if val != nil {
            m.SetValuesJoinedBy(val.(*i1064077c0deed3e13037469d51458ffc82d2db75e239cd9605f39aaa91186035.BinaryOperator))
        }
        return nil
    }
    return res
...
func (m *PropertyRule) GetValuesJoinedBy()(*i1064077c0deed3e13037469d51458ffc82d2db75e239cd9605f39aaa91186035.BinaryOperator) {
    val, err := m.GetBackingStore().Get("valuesJoinedBy")
    if err != nil {
        panic(err)
    }
    if val != nil {
        return val.(*i1064077c0deed3e13037469d51458ffc82d2db75e239cd9605f39aaa91186035.BinaryOperator)
    }
    return nil
}
...
func (m *PropertyRule) SetValuesJoinedBy(value *i1064077c0deed3e13037469d51458ffc82d2db75e239cd9605f39aaa91186035.BinaryOperator)() {
...
type PropertyRuleable interface {
    ...
    GetProperty()(*string)
    GetValues()([]string)
    GetValuesJoinedBy()(*i1064077c0deed3e13037469d51458ffc82d2db75e239cd9605f39aaa91186035.BinaryOperator)
    SetBackingStore(value ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackingStore)()
    SetOdataType(value *string)()
    SetOperation(value *RuleOperation)()
    SetProperty(value *string)()
    SetValues(value []string)()
    SetValuesJoinedBy(value *i1064077c0deed3e13037469d51458ffc82d2db75e239cd9605f39aaa91186035.BinaryOperator)()
}
