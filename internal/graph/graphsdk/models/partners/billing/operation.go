...
func (m *Operation) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
    ...
    res["status"] = func (n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
        val, err := n.GetEnumValue(i1064077c0deed3e13037469d51458ffc82d2db75e239cd9605f39aaa91186035.ParseLongRunningOperationStatus)
        if err != nil {
            return err
        }
        if val != nil {
            m.SetStatus(val.(*i1064077c0deed3e13037469d51458ffc82d2db75e239cd9605f39aaa91186035.LongRunningOperationStatus))
        }
        return nil
    }
    return res
...
func (m *Operation) GetStatus()(*i1064077c0deed3e13037469d51458ffc82d2db75e239cd9605f39aaa91186035.LongRunningOperationStatus) {
    val, err := m.GetBackingStore().Get("status")
    if err != nil {
        panic(err)
    }
    if val != nil {
        return val.(*i1064077c0deed3e13037469d51458ffc82d2db75e239cd9605f39aaa91186035.LongRunningOperationStatus)
    }
    return nil
}
...
func (m *Operation) SetStatus(value *i1064077c0deed3e13037469d51458ffc82d2db75e239cd9605f39aaa91186035.LongRunningOperationStatus)() {
...
type Operationable interface {
    ...
    GetStatus()(*i1064077c0deed3e13037469d51458ffc82d2db75e239cd9605f39aaa91186035.LongRunningOperationStatus)
    SetCreatedDateTime(value *i336074805fc853987abe6f7fe3ad97a6a6f3077a16391fec744f671a015fbd7e.Time)()
    SetLastActionDateTime(value *i336074805fc853987abe6f7fe3ad97a6a6f3077a16391fec744f671a015fbd7e.Time)()
    SetStatus(value *i1064077c0deed3e13037469d51458ffc82d2db75e239cd9605f39aaa91186035.LongRunningOperationStatus)()
}
