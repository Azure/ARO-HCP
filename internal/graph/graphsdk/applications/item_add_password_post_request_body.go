...
func (m *ItemAddPasswordPostRequestBody) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
    ...
    res["passwordCredential"] = func (n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
        val, err := n.GetObjectValue(i1064077c0deed3e13037469d51458ffc82d2db75e239cd9605f39aaa91186035.CreatePasswordCredentialFromDiscriminatorValue)
        if err != nil {
            return err
        }
        if val != nil {
            m.SetPasswordCredential(val.(i1064077c0deed3e13037469d51458ffc82d2db75e239cd9605f39aaa91186035.PasswordCredentialable))
        }
        return nil
    }
    return res
...
func (m *ItemAddPasswordPostRequestBody) GetPasswordCredential()(i1064077c0deed3e13037469d51458ffc82d2db75e239cd9605f39aaa91186035.PasswordCredentialable) {
    val, err := m.GetBackingStore().Get("passwordCredential")
    if err != nil {
        panic(err)
    }
    if val != nil {
        return val.(i1064077c0deed3e13037469d51458ffc82d2db75e239cd9605f39aaa91186035.PasswordCredentialable)
    }
    return nil
}
...
func (m *ItemAddPasswordPostRequestBody) SetPasswordCredential(value i1064077c0deed3e13037469d51458ffc82d2db75e239cd9605f39aaa91186035.PasswordCredentialable)() {
...
type ItemAddPasswordPostRequestBodyable interface {
    ...
    GetPasswordCredential()(i1064077c0deed3e13037469d51458ffc82d2db75e239cd9605f39aaa91186035.PasswordCredentialable)
    SetBackingStore(value ie8677ce2c7e1b4c22e9c3827ecd078d41185424dd9eeb92b7d971ed2d49a392e.BackingStore)()
    SetPasswordCredential(value i1064077c0deed3e13037469d51458ffc82d2db75e239cd9605f39aaa91186035.PasswordCredentialable)()
}
