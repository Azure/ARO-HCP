...
package kubeapplierinformers_test
...
func startAndSync(t *testing.T, ctx context.Context, info kubeapplierinformers.KubeApplierInformers) {
	t.Helper()
...
func TestKubeApplierInformers_ListByManagementCluster(t *testing.T) {
	...
	info := kubeapplierinformers.NewKubeApplierInformersWithRelistDuration(ctx, mock.Listers(), mock, &relistDuration)
...
var (
	_ kubeapplierlisters.ApplyDesireLister = (kubeapplierlisters.ApplyDesireLister)(nil)
	_ kubeapplierlisters.ReadDesireLister  = (kubeapplierlisters.ReadDesireLister)(nil)
)
