...
type KubeApplierInformers interface {
	ApplyDesires() (cache.SharedIndexInformer, kubeapplierlisters.ApplyDesireLister)
	ReadDesires() (cache.SharedIndexInformer, kubeapplierlisters.ReadDesireLister)
...
func (k *kubeApplierInformers) ApplyDesires() (cache.SharedIndexInformer, kubeapplierlisters.ApplyDesireLister) {
	return k.applyDesireInformer, k.applyDesireLister
}

func (k *kubeApplierInformers) ReadDesires() (cache.SharedIndexInformer, kubeapplierlisters.ReadDesireLister) {
...
func NewKubeApplierInformersWithRelistDuration(
	...
	ret.applyDesireLister = kubeapplierlisters.NewApplyDesireLister(ret.applyDesireInformer.GetIndexer())
	ret.readDesireLister = kubeapplierlisters.NewReadDesireLister(ret.readDesireInformer.GetIndexer())
