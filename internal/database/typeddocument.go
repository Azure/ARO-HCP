...
type typedDocument[T DocumentProperties] struct {
	baseDocument
...
func newTypedDocument[T DocumentProperties](partitionKey string, resourceType azcorearm.ResourceType) *typedDocument[T] {
...
func (td *typedDocument[T]) getPartitionKey() azcosmos.PartitionKey {
...
func (td *typedDocument[T]) validateType(properties *T) error {
...
func typedDocumentMarshal[T DocumentProperties](typedDoc *typedDocument[T], innerDoc *T) ([]byte, error) {
...
func typedDocumentUnmarshal[T DocumentProperties](data []byte) (*typedDocument[T], *T, error) {
	var typedDoc typedDocument[T]
	var innerDoc T
