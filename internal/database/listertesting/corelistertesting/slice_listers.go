...
type SliceSystemAdminCredentialRequestLister struct {
	CredentialRequests []*api.SystemAdminCredentialRequest
}

var _ corelisters.SystemAdminCredentialRequestLister = &SliceSystemAdminCredentialRequestLister{}

func (l *SliceSystemAdminCredentialRequestLister) List(ctx context.Context) ([]*api.SystemAdminCredentialRequest, error) {
	return l.CredentialRequests, nil
}

func (l *SliceSystemAdminCredentialRequestLister) Get(ctx context.Context, subscriptionID, resourceGroupName, clusterName, credentialName string) (*api.SystemAdminCredentialRequest, error) {
...
func (l *SliceSystemAdminCredentialRequestLister) ListForCluster(ctx context.Context, subscriptionID, resourceGroupName, clusterName string) ([]*api.SystemAdminCredentialRequest, error) {
	var result []*api.SystemAdminCredentialRequest
	for _, cred := range l.CredentialRequests {
		resourceID := cred.GetResourceID()
		if resourceID == nil {
			continue
...
type SliceSystemAdminCredentialRevocationLister struct {
	CredentialRevocations []*api.SystemAdminCredentialRevocation
}

var _ corelisters.SystemAdminCredentialRevocationLister = &SliceSystemAdminCredentialRevocationLister{}

func (l *SliceSystemAdminCredentialRevocationLister) List(ctx context.Context) ([]*api.SystemAdminCredentialRevocation, error) {
	return l.CredentialRevocations, nil
}

func (l *SliceSystemAdminCredentialRevocationLister) Get(ctx context.Context, subscriptionID, resourceGroupName, clusterName, revocationName string) (*api.SystemAdminCredentialRevocation, error) {
...
func (l *SliceSystemAdminCredentialRevocationLister) ListForCluster(ctx context.Context, subscriptionID, resourceGroupName, clusterName string) ([]*api.SystemAdminCredentialRevocation, error) {
	var result []*api.SystemAdminCredentialRevocation
	for _, rev := range l.CredentialRevocations {
		resourceID := rev.GetResourceID()
		if resourceID == nil {
			continue
