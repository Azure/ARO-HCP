...
// Package listertestingutils holds the shared helpers used by the split
// lister test packages (fleet/kubeapplier/core): resource-ID predicates and
// the generic iterator collector.
