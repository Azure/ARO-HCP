...
func (d *cosmosDBClient) getResourceDoc(ctx context.Context, resourceID *azcorearm.ResourceID) (*typedDocument[ResourceDocument], *ResourceDocument, error) {
	pk := NewPartitionKey(resourceID.SubscriptionID)

	query := "SELECT * FROM c WHERE STRINGEQUALS(c.resourceType, @resourceType, true) AND STRINGEQUALS(c.properties.resourceId, @resourceId, true)"
...
func (d *cosmosDBClient) CreateResourceDoc(ctx context.Context, doc *ResourceDocument) error {
	typedDoc := newTypedDocument[ResourceDocument](doc.ResourceID.SubscriptionID, doc.ResourceID.ResourceType)
...
func (d *cosmosDBClient) UpdateResourceDoc(ctx context.Context, resourceID *azcorearm.ResourceID, callback func(*ResourceDocument) bool) (bool, error) {
	...
	for try := 0; try < 5; try++ {
		var typedDoc *typedDocument[ResourceDocument]
...
func (d *cosmosDBClient) getOperationDoc(ctx context.Context, pk azcosmos.PartitionKey, operationID string) (*typedDocument[OperationDocument], *OperationDocument, error) {
...
func (d *cosmosDBClient) CreateOperationDoc(ctx context.Context, doc *OperationDocument) (string, error) {
	...
	typedDoc := newTypedDocument[OperationDocument](subscriptionID, OperationResourceType)
...
func (d *cosmosDBClient) UpdateOperationDoc(ctx context.Context, pk azcosmos.PartitionKey, operationID string, callback func(*OperationDocument) bool) (bool, error) {
	...
	for try := 0; try < 5; try++ {
		var typedDoc *typedDocument[OperationDocument]
...
func (d *cosmosDBClient) getSubscriptionDoc(ctx context.Context, subscriptionID string) (*typedDocument[arm.Subscription], *arm.Subscription, error) {
	// Make sure lookup keys are lowercase.
...
func (d *cosmosDBClient) CreateSubscriptionDoc(ctx context.Context, subscriptionID string, subscription *arm.Subscription) error {
	typedDoc := newTypedDocument[arm.Subscription](subscriptionID, azcorearm.SubscriptionResourceType)
...
func (d *cosmosDBClient) UpdateSubscriptionDoc(ctx context.Context, subscriptionID string, callback func(*arm.Subscription) bool) (bool, error) {
	...
	for try := 0; try < 5; try++ {
		var typedDoc *typedDocument[arm.Subscription]
