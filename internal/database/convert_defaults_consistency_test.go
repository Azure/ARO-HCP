...
func TestCSToRPDefaultsEmptyDiskStorageAccountType(t *testing.T) {
	...
	if rpNodePool.Properties.Platform.OSDisk.DiskStorageAccountType != resourcesapi.DiskStorageAccountTypePremium_LRS {
...
func TestCSToRPDefaultsEmptyDiskType(t *testing.T) {
	...
	if rpNodePool.Properties.Platform.OSDisk.DiskType != resourcesapi.OsDiskTypeManaged {
