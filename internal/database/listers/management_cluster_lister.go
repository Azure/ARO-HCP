...
type ManagementClusterLister interface {
	...
	Get(ctx context.Context, subscriptionID, resourceGroupName, name string) (*fleet.ManagementCluster, error)
...
func (l *informerBasedManagementClusterLister) Get(ctx context.Context, subscriptionID, resourceGroupName, name string) (*fleet.ManagementCluster, error) {
