...
func TestConvertCSManagementClusterToInternal(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			validate: func(t *testing.T, mc *fleet.ManagementCluster) {
				// ResourceID
				expectedResourceID := api.Must(fleet.ToManagementClusterResourceID("00000000-0000-0000-0000-000000000000", "rg", "test-westus3-mgmt-1"))
				...
				// Spec
				assert.Equal(t, "test-westus3-mgmt-1", mc.Spec.StampIdentifier, "stamp identifier should be AKS cluster name")
