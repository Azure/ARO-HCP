...
//
// The cluster's cluster service update dispatchcontroller compares desired and
...
//	    truth yet or simply can't be calcultated from there
...
func clusterUpdateDispatchConfigServiceProviderClusterDispatchDesiredHostedClusterControlPlaneSizeFromCS(in *arohcpv1alpha1.Cluster) *string {
	...
	// When the property value does not mach any of the ones any of the ones that match to a corresponding
