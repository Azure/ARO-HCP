...
var _ metaapi.CosmosPersistable = &HCPOpenShiftCluster{}

func (o *HCPOpenShiftCluster) GetCosmosData() *metaapi.CosmosMetadata {
...
func (o *HCPOpenShiftCluster) Validate() []armresourcesapi.CloudErrorBody {
	return nil
}
