...
var _ metaapi.CosmosPersistable = &HCPOpenShiftClusterExternalAuth{}

func (o *HCPOpenShiftClusterExternalAuth) GetCosmosData() *metaapi.CosmosMetadata {
...
func (o *HCPOpenShiftClusterExternalAuth) Validate() []armresourcesapi.CloudErrorBody {
	return nil
}
