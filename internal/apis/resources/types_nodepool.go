...
var _ metaapi.CosmosPersistable = &HCPOpenShiftClusterNodePool{}

func (o *HCPOpenShiftClusterNodePool) GetCosmosData() *metaapi.CosmosMetadata {
	return &metaapi.CosmosMetadata{
...
func NewDefaultHCPOpenShiftClusterNodePool(resourceID *azcorearm.ResourceID, azureLocation string) *HCPOpenShiftClusterNodePool {
	return &HCPOpenShiftClusterNodePool{
		TrackedResource: armresourcesapi.NewTrackedResource(resourceID, azureLocation),
...
func (nodePool *HCPOpenShiftClusterNodePool) validateVersion(cluster *HCPOpenShiftCluster) []armresourcesapi.CloudErrorBody {
	var errorDetails []armresourcesapi.CloudErrorBody

	if nodePool.Properties.Version.ChannelGroup != cluster.CustomerProperties.Version.ChannelGroup {
		errorDetails = append(errorDetails, armresourcesapi.CloudErrorBody{
...
func (nodePool *HCPOpenShiftClusterNodePool) validateSubnetID(cluster *HCPOpenShiftCluster) []armresourcesapi.CloudErrorBody {
	var errorDetails []armresourcesapi.CloudErrorBody
...
func (nodePool *HCPOpenShiftClusterNodePool) Validate(cluster *HCPOpenShiftCluster) []armresourcesapi.CloudErrorBody {
	var errorDetails []armresourcesapi.CloudErrorBody
