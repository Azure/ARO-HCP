...
// ClusterImageRegistryState - state indicates the desired ImageStream-backed cluster image registry installation mode.
...
var (
	ValidClusterImageRegistryStates = sets.New[ClusterImageRegistryState](
