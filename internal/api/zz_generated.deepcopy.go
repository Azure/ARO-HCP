...
func (in *HCPOpenShiftClusterExternalAuthServiceProviderProperties) DeepCopyInto(out *HCPOpenShiftClusterExternalAuthServiceProviderProperties) {
	*out = *in
	...
	if in.ProvisioningConditions != nil {
		in, out := &in.ProvisioningConditions, &out.ProvisioningConditions
		*out = make([]ProvisioningCondition, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ProvisioningCondition) DeepCopyInto(out *ProvisioningCondition) {
	*out = *in
	in.Condition.DeepCopyInto(&out.Condition)
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ProvisioningCondition.
func (in *ProvisioningCondition) DeepCopy() *ProvisioningCondition {
	if in == nil {
		return nil
	}
	out := new(ProvisioningCondition)
	in.DeepCopyInto(out)
	return out
}
