...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ServiceProviderNodePoolActiveVersions) DeepCopyInto(out *ServiceProviderNodePoolActiveVersions) {
	*out = *in
	if in.Version != nil {
		in, out := &in.Version, &out.Version
		*out = new(v4.Version)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ServiceProviderNodePoolActiveVersions.
func (in *ServiceProviderNodePoolActiveVersions) DeepCopy() *ServiceProviderNodePoolActiveVersions {
	if in == nil {
		return nil
	}
	out := new(ServiceProviderNodePoolActiveVersions)
	in.DeepCopyInto(out)
	return out
}
...
func (in *ServiceProviderNodePoolStatus) DeepCopyInto(out *ServiceProviderNodePoolStatus) {
	*out = *in
	if in.NodePoolActiveVersions != nil {
		in, out := &in.NodePoolActiveVersions, &out.NodePoolActiveVersions
		*out = make([]ServiceProviderNodePoolActiveVersions, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
