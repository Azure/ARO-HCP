...
func (in *ServiceProviderClusterStatus) DeepCopyInto(out *ServiceProviderClusterStatus) {
	*out = *in
	...
	if in.PendingDenyAssignments != nil {
		in, out := &in.PendingDenyAssignments, &out.PendingDenyAssignments
		*out = make([]DenyAssignmentReference, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	if in.DenyAssignments != nil {
		in, out := &in.DenyAssignments, &out.DenyAssignments
		*out = make([]DenyAssignmentReference, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
