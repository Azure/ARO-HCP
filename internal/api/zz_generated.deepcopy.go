...
func (in *ServiceProviderClusterStatus) DeepCopyInto(out *ServiceProviderClusterStatus) {
	*out = *in
	...
	if in.Validations != nil {
		...
		*out = make([]ValidationStatus, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ValidationInternalStatus) DeepCopyInto(out *ValidationInternalStatus) {
	*out = *in
	if in.EarliestRetryAfterSeconds != nil {
		in, out := &in.EarliestRetryAfterSeconds, &out.EarliestRetryAfterSeconds
		*out = new(int64)
		**out = **in
	}
	return
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ValidationInternalStatus.
func (in *ValidationInternalStatus) DeepCopy() *ValidationInternalStatus {
	if in == nil {
		return nil
	}
	out := new(ValidationInternalStatus)
	in.DeepCopyInto(out)
	return out
}
