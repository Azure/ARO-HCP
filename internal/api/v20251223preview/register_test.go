...
func TestClusterVisibilityMap(t *testing.T) {
	...
	expectedVisibility := map[string]api.VisibilityFlags{
		...
		"Properties.Platform.LoadBalancer":         api.SkipVisibilityTest,
		"Properties.Platform.LoadBalancer.EffectiveOutboundIPs":                                     api.SkipVisibilityTest,
		"Properties.Platform.LoadBalancer.EffectiveOutboundIPs.ID":                                  api.VisibilityRead,
		"Properties.Platform.LoadBalancer.ManagedOutboundIPs":                                       api.VisibilityRead | api.VisibilityCreate | api.VisibilityUpdate,
		"Properties.Platform.LoadBalancer.ManagedOutboundIPs.Count":                                 api.VisibilityRead | api.VisibilityCreate | api.VisibilityUpdate,
