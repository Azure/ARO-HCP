...
func (in *DNSReservation) DeepCopyInto(out *DNSReservation) {
	*out = *in
	in.CosmosMetadata.DeepCopyInto(&out.CosmosMetadata)
	if in.MustBindByTime != nil {
		in, out := &in.MustBindByTime, &out.MustBindByTime
		*out = (*in).DeepCopy()
	}
	if in.OwningCluster != nil {
		in, out := &in.OwningCluster, &out.OwningCluster
		*out = DeepCopyResourceID(*in)
	}
...
func (in *ServiceProviderClusterStatus) DeepCopyInto(out *ServiceProviderClusterStatus) {
	*out = *in
	...
	if in.KubeAPIServerDNSReservation != nil {
		in, out := &in.KubeAPIServerDNSReservation, &out.KubeAPIServerDNSReservation
		*out = DeepCopyResourceID(*in)
	}
	return
}
