...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ManagedIdentityDetails) DeepCopyInto(out *ManagedIdentityDetails) {
	*out = *in
	if in.ResourceID != nil {
		in, out := &in.ResourceID, &out.ResourceID
		*out = DeepCopyResourceID(*in)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ManagedIdentityDetails.
func (in *ManagedIdentityDetails) DeepCopy() *ManagedIdentityDetails {
	if in == nil {
		return nil
	}
	out := new(ManagedIdentityDetails)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ManagedIdentityDetailsKey) DeepCopyInto(out *ManagedIdentityDetailsKey) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ManagedIdentityDetailsKey.
func (in *ManagedIdentityDetailsKey) DeepCopy() *ManagedIdentityDetailsKey {
	if in == nil {
		return nil
	}
	out := new(ManagedIdentityDetailsKey)
	in.DeepCopyInto(out)
	return out
}
...
func (in *ServiceProviderClusterStatus) DeepCopyInto(out *ServiceProviderClusterStatus) {
	*out = *in
	...
	if in.ManagedIdentityDetails != nil {
		...
		*out = make(map[ManagedIdentityDetailsKey]*ManagedIdentityDetails, len(*in))
		for key, val := range *in {
			var outVal *ManagedIdentityDetails
			if val == nil {
				(*out)[key] = nil
			} else {
				in, out := &val, &outVal
