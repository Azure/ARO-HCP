...
func (in *ServiceProviderClusterMSIManagedIdentities) DeepCopyInto(out *ServiceProviderClusterMSIManagedIdentities) {
	*out = *in
	...
	if in.Identities != nil {
		...
		*out = make(map[string]*ServiceProviderClusterMSIManagedIdentity, len(*in))
		for key, val := range *in {
			var outVal *ServiceProviderClusterMSIManagedIdentity
			if val == nil {
				(*out)[key] = nil
			} else {
				in, out := &val, &outVal
				*out = new(ServiceProviderClusterMSIManagedIdentity)
				(*in).DeepCopyInto(*out)
			}
			(*out)[key] = outVal
		}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ServiceProviderClusterMSIManagedIdentity) DeepCopyInto(out *ServiceProviderClusterMSIManagedIdentity) {
	*out = *in
	if in.ResourceID != nil {
		in, out := &in.ResourceID, &out.ResourceID
		*out = DeepCopyResourceID(*in)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ServiceProviderClusterMSIManagedIdentity.
func (in *ServiceProviderClusterMSIManagedIdentity) DeepCopy() *ServiceProviderClusterMSIManagedIdentity {
	if in == nil {
		return nil
	}
	out := new(ServiceProviderClusterMSIManagedIdentity)
