...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in RecoveryRequests) DeepCopyInto(out *RecoveryRequests) {
	{
		in := &in
		*out = make(RecoveryRequests, len(*in))
		copy(*out, *in)
		return
	}
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new RecoveryRequests.
func (in RecoveryRequests) DeepCopy() RecoveryRequests {
	if in == nil {
		return nil
	}
	out := new(RecoveryRequests)
	in.DeepCopyInto(out)
	return *out
}
...
func (in *ServiceProviderClusterSpec) DeepCopyInto(out *ServiceProviderClusterSpec) {
	*out = *in
	...
	if in.RecoveryRequests != nil {
		in, out := &in.RecoveryRequests, &out.RecoveryRequests
		*out = make(RecoveryRequests, len(*in))
		copy(*out, *in)
	}
	return
...
func (in *ServiceProviderClusterStatus) DeepCopyInto(out *ServiceProviderClusterStatus) {
	*out = *in
	...
	if in.Recoveries != nil {
		...
		*out = make([]RecoveryStatus, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
