...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *DataplaneOIDCFederationIdentityInstance) DeepCopyInto(out *DataplaneOIDCFederationIdentityInstance) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new DataplaneOIDCFederationIdentityInstance.
func (in *DataplaneOIDCFederationIdentityInstance) DeepCopy() *DataplaneOIDCFederationIdentityInstance {
	if in == nil {
		return nil
	}
	out := new(DataplaneOIDCFederationIdentityInstance)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *DataplaneOIDCFederationOperatorStatus) DeepCopyInto(out *DataplaneOIDCFederationOperatorStatus) {
	*out = *in
	if in.EnsuredIdentity != nil {
		in, out := &in.EnsuredIdentity, &out.EnsuredIdentity
		*out = new(DataplaneOIDCFederationIdentityInstance)
		**out = **in
	}
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new DataplaneOIDCFederationOperatorStatus.
func (in *DataplaneOIDCFederationOperatorStatus) DeepCopy() *DataplaneOIDCFederationOperatorStatus {
	if in == nil {
		return nil
	}
	out := new(DataplaneOIDCFederationOperatorStatus)
	in.DeepCopyInto(out)
	return out
}
...
func (in *ManagedIdentityDataplaneOIDCFederationStatus) DeepCopyInto(out *ManagedIdentityDataplaneOIDCFederationStatus) {
	*out = *in
	out.TargetIdentity = in.TargetIdentity
	if in.Operators != nil {
		in, out := &in.Operators, &out.Operators
		*out = make(map[string]*DataplaneOIDCFederationOperatorStatus, len(*in))
		for key, val := range *in {
			var outVal *DataplaneOIDCFederationOperatorStatus
			if val == nil {
				(*out)[key] = nil
			} else {
				in, out := &val, &outVal
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ServiceProviderClusterActiveVersion) DeepCopyInto(out *ServiceProviderClusterActiveVersion) {
	*out = *in
	if in.Version != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ServiceProviderClusterActiveVersion.
func (in *ServiceProviderClusterActiveVersion) DeepCopy() *ServiceProviderClusterActiveVersion {
	if in == nil {
		return nil
	}
	out := new(ServiceProviderClusterActiveVersion)
	in.DeepCopyInto(out)
	return out
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ServiceProviderClusterPlacementStatus) DeepCopyInto(out *ServiceProviderClusterPlacementStatus) {
	*out = *in
	if in.Conditions != nil {
		in, out := &in.Conditions, &out.Conditions
		*out = make([]v1.Condition, len(*in))
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ServiceProviderClusterPlacementStatus.
func (in *ServiceProviderClusterPlacementStatus) DeepCopy() *ServiceProviderClusterPlacementStatus {
	if in == nil {
		return nil
	}
	out := new(ServiceProviderClusterPlacementStatus)
	in.DeepCopyInto(out)
	return out
}
...
func (in *ServiceProviderClusterStatusVersion) DeepCopyInto(out *ServiceProviderClusterStatusVersion) {
	*out = *in
	if in.ActiveVersions != nil {
		in, out := &in.ActiveVersions, &out.ActiveVersions
		*out = make([]ServiceProviderClusterActiveVersion, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ServiceProviderNodePoolActiveVersion) DeepCopyInto(out *ServiceProviderNodePoolActiveVersion) {
	*out = *in
	if in.Version != nil {
		in, out := &in.Version, &out.Version
		*out = new(v4.Version)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ServiceProviderNodePoolActiveVersion.
func (in *ServiceProviderNodePoolActiveVersion) DeepCopy() *ServiceProviderNodePoolActiveVersion {
	if in == nil {
		return nil
	}
	out := new(ServiceProviderNodePoolActiveVersion)
	in.DeepCopyInto(out)
	return out
}
...
func (in *ServiceProviderNodePoolStatusVersion) DeepCopyInto(out *ServiceProviderNodePoolStatusVersion) {
	*out = *in
	if in.ActiveVersions != nil {
		in, out := &in.ActiveVersions, &out.ActiveVersions
		*out = make([]ServiceProviderNodePoolActiveVersion, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
