...
func NewResourceNotFoundError(resourceID *azcorearm.ResourceID) *CloudError {
	...
	switch {
	case metadataapi.ResourceTypeEqual(resourceID.ResourceType, azcorearm.SubscriptionResourceType):
		code = CloudErrorCodeSubscriptionNotFound
		message = fmt.Sprintf(
			"The subscription '%s' was not found.",
			resourceID.SubscriptionID)
	case metadataapi.ResourceTypeEqual(resourceID.ResourceType, azcorearm.ResourceGroupResourceType):
