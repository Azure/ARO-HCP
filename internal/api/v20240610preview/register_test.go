...
func TestClusterStructTagMap(t *testing.T) {
	...
	expectedVisibility := map[string]api.VisibilityFlags{
		...
		"Tags":                                        api.VisibilityRead | api.VisibilityCreate | api.VisibilityUpdate,
		"Properties":                                  skip,
		...
		"Properties.Proxy":                                                       skip,
		"Properties.Proxy.HTTPProxy":                                             api.VisibilityRead | api.VisibilityCreate | api.VisibilityUpdate,
		"Properties.Proxy.HTTPSProxy":                                            api.VisibilityRead | api.VisibilityCreate | api.VisibilityUpdate,
		"Properties.Proxy.NoProxy":                                               api.VisibilityRead | api.VisibilityCreate | api.VisibilityUpdate,
		"Properties.Proxy.TrustedCA":                                             api.VisibilityRead | api.VisibilityCreate | api.VisibilityUpdate,
		...
		"Properties.Etcd.DataEncryption.CustomerManaged.Kms":                     skip,
		"Properties.Etcd.DataEncryption.CustomerManaged.Kms.ActiveKey":           skip,
...
func TestNodePoolStructTagMap(t *testing.T) {
	...
	expectedVisibility := map[string]api.VisibilityFlags{
		...
		"Properties.Platform.OSDisk":                        skip,
