...
func TestNodePoolStructTagMap(t *testing.T) {
	...
	expectedVisibility := map[string]api.VisibilityFlags{
		...
		"Properties.Platform.OsDiskProfile.SizeGiB":                api.VisibilityRead | api.VisibilityCreate,
		"Properties.Platform.OsDiskProfile.DiskStorageAccountType": api.VisibilityRead | api.VisibilityCreate,
		"Properties.Platform.OsDiskProfile.EncryptionSetId":        api.VisibilityRead | api.VisibilityCreate,
