...
func TestClusterStructTagMap(t *testing.T) {
	...
	expectedVisibility := map[string]api.VisibilityFlags{
		...
		"Properties.Autoscaling.MaxNodesTotal":           api.VisibilityRead | api.VisibilityCreate,
		"Properties.Autoscaling.MaxPodGracePeriod":       api.VisibilityRead | api.VisibilityCreate,
		"Properties.Autoscaling.MaxNodeProvisionTime":    api.VisibilityRead | api.VisibilityCreate,
		"Properties.Autoscaling.MaxpodPriorityThreshold": api.VisibilityRead | api.VisibilityCreate,
