...
// EncryptionInfrastructureEncryption - Infrastructure-level encryption setting. Default is "disabled".
...
// KeyEncryptionKeyIdentityType - Type of identity used to access the Key Vault.
