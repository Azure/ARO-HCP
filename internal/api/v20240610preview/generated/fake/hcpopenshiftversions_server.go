...
func (h *HcpOpenShiftVersionsServerTransport) dispatchGet(req *http.Request) (*http.Response, error) {
	...
	const regexStr = `/subscriptions/(?P<subscriptionId>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)/locations/(?P<location>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)/providers/Microsoft\.RedHatOpenShift/hcpOpenShiftVersions/(?P<hcpOpenShiftVersionName>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)`
