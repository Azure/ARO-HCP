...
// ExternalAuthsServer is a fake server for instances of the generated.ExternalAuthsClient type.
type ExternalAuthsServer struct {
	...
	BeginCreateOrUpdate func(ctx context.Context, resourceGroupName string, hcpOpenShiftClusterName string, externalAuthName string, resource generated.ExternalAuth, options *generated.ExternalAuthsClientBeginCreateOrUpdateOptions) (resp azfake.PollerResponder[generated.ExternalAuthsClientCreateOrUpdateResponse], errResp azfake.ErrorResponder)

	// BeginDelete is the fake for method ExternalAuthsClient.BeginDelete
	// HTTP status codes to indicate success: http.StatusAccepted, http.StatusNoContent
	BeginDelete func(ctx context.Context, resourceGroupName string, hcpOpenShiftClusterName string, externalAuthName string, options *generated.ExternalAuthsClientBeginDeleteOptions) (resp azfake.PollerResponder[generated.ExternalAuthsClientDeleteResponse], errResp azfake.ErrorResponder)

	// Get is the fake for method ExternalAuthsClient.Get
	// HTTP status codes to indicate success: http.StatusOK
	Get func(ctx context.Context, resourceGroupName string, hcpOpenShiftClusterName string, externalAuthName string, options *generated.ExternalAuthsClientGetOptions) (resp azfake.Responder[generated.ExternalAuthsClientGetResponse], errResp azfake.ErrorResponder)

	// NewListByParentPager is the fake for method ExternalAuthsClient.NewListByParentPager
	// HTTP status codes to indicate success: http.StatusOK
	NewListByParentPager func(resourceGroupName string, hcpOpenShiftClusterName string, options *generated.ExternalAuthsClientListByParentOptions) (resp azfake.PagerResponder[generated.ExternalAuthsClientListByParentResponse])

	// BeginUpdate is the fake for method ExternalAuthsClient.BeginUpdate
	// HTTP status codes to indicate success: http.StatusOK, http.StatusAccepted
	BeginUpdate func(ctx context.Context, resourceGroupName string, hcpOpenShiftClusterName string, externalAuthName string, properties generated.ExternalAuthUpdate, options *generated.ExternalAuthsClientBeginUpdateOptions) (resp azfake.PollerResponder[generated.ExternalAuthsClientUpdateResponse], errResp azfake.ErrorResponder)
}

// NewExternalAuthsServerTransport creates a new instance of ExternalAuthsServerTransport with the provided implementation.
// The returned ExternalAuthsServerTransport instance is connected to an instance of generated.ExternalAuthsClient via the
...
func NewExternalAuthsServerTransport(srv *ExternalAuthsServer) *ExternalAuthsServerTransport {
	return &ExternalAuthsServerTransport{
		srv:                  srv,
		beginCreateOrUpdate:  newTracker[azfake.PollerResponder[generated.ExternalAuthsClientCreateOrUpdateResponse]](),
		beginDelete:          newTracker[azfake.PollerResponder[generated.ExternalAuthsClientDeleteResponse]](),
		newListByParentPager: newTracker[azfake.PagerResponder[generated.ExternalAuthsClientListByParentResponse]](),
		beginUpdate:          newTracker[azfake.PollerResponder[generated.ExternalAuthsClientUpdateResponse]](),
	}
}

// ExternalAuthsServerTransport connects instances of generated.ExternalAuthsClient to instances of ExternalAuthsServer.
...
type ExternalAuthsServerTransport struct {
	...
	beginCreateOrUpdate  *tracker[azfake.PollerResponder[generated.ExternalAuthsClientCreateOrUpdateResponse]]
	beginDelete          *tracker[azfake.PollerResponder[generated.ExternalAuthsClientDeleteResponse]]
	newListByParentPager *tracker[azfake.PagerResponder[generated.ExternalAuthsClientListByParentResponse]]
	beginUpdate          *tracker[azfake.PollerResponder[generated.ExternalAuthsClientUpdateResponse]]
}
...
func (e *ExternalAuthsServerTransport) dispatchBeginCreateOrUpdate(req *http.Request) (*http.Response, error) {
	...
	if beginCreateOrUpdate == nil {
		...
		body, err := server.UnmarshalRequestAsJSON[generated.ExternalAuth](req)
		if err != nil {
			return nil, err
		}
...
func (e *ExternalAuthsServerTransport) dispatchNewListByParentPager(req *http.Request) (*http.Response, error) {
	...
	if newListByParentPager == nil {
		...
		server.PagerResponderInjectNextLinks(newListByParentPager, req, func(page *generated.ExternalAuthsClientListByParentResponse, createLink func() string) {
...
func (e *ExternalAuthsServerTransport) dispatchBeginUpdate(req *http.Request) (*http.Response, error) {
	...
	if beginUpdate == nil {
		...
		body, err := server.UnmarshalRequestAsJSON[generated.ExternalAuthUpdate](req)
		if err != nil {
			return nil, err
		}
		resourceGroupNameParam, err := url.PathUnescape(matches[regex.SubexpIndex("resourceGroupName")])
