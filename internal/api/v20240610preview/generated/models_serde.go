...
func (c CustomerManagedConfig) MarshalJSON() ([]byte, error) {
	...
	populate(objectMap, "kmsConfig", c.KmsConfig)
	return json.Marshal(objectMap)
}
...
func (c *CustomerManagedConfig) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "encryptionType":
			...
			delete(rawMsg, key)
		case "kmsConfig":
			err = unpopulate(val, "KmsConfig", &c.KmsConfig)
			delete(rawMsg, key)
		default:
			err = fmt.Errorf("unmarshalling type %T, unknown field %q", c, key)
		}
...
func (e EtcdDataEncryptionProfile) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "customerManagedConfig", e.CustomerManagedConfig)
...
func (e *EtcdDataEncryptionProfile) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		var err error
		switch key {
		case "customerManagedConfig":
			err = unpopulate(val, "CustomerManagedConfig", &e.CustomerManagedConfig)
			delete(rawMsg, key)
		case "managementMode":
...
// MarshalJSON implements the json.Marshaller interface for type KmsConfig.
func (k KmsConfig) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "activeKey", k.ActiveKey)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type KmsConfig.
func (k *KmsConfig) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
...
// MarshalJSON implements the json.Marshaller interface for type NonUpdatableKmsKey.
func (n NonUpdatableKmsKey) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "name", n.Name)
	populate(objectMap, "vaultName", n.VaultName)
	populate(objectMap, "version", n.Version)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type NonUpdatableKmsKey.
func (n *NonUpdatableKmsKey) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", n, err)
	}
	for key, val := range rawMsg {
		...
		case "name":
			...
			delete(rawMsg, key)
		case "vaultName":
			err = unpopulate(val, "VaultName", &n.VaultName)
			delete(rawMsg, key)
		case "version":
			err = unpopulate(val, "Version", &n.Version)
			delete(rawMsg, key)
