...
func (h HcpOpenShiftVersionProperties) MarshalJSON() ([]byte, error) {
	...
	populate(objectMap, "supportedArchitectures", h.SupportedArchitectures)
	return json.Marshal(objectMap)
}
...
func (h *HcpOpenShiftVersionProperties) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "supportedArchitectures":
			err = unpopulate(val, "SupportedArchitectures", &h.SupportedArchitectures)
			delete(rawMsg, key)
		default:
			err = fmt.Errorf("unmarshalling type %T, unknown field %q", h, key)
		}
...
// MarshalJSON implements the json.Marshaller interface for type VersionArchitecture.
func (v VersionArchitecture) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
...
// UnmarshalJSON implements the json.Unmarshaller interface for type VersionArchitecture.
func (v *VersionArchitecture) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
