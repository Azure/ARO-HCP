...
type HcpOpenShiftVersionProperties struct {
	...
	// REQUIRED; SupportedArchitectures contains version information for each supported architecture.
	SupportedArchitectures []*VersionArchitecture
}
...
// VersionArchitecture contains architecture-specific version information.
type VersionArchitecture struct {
	// REQUIRED; AvailableUpgrades is the list of available upgrade versions for this architecture.
	AvailableUpgrades []*string

	// REQUIRED; Name of the architecture.
	Name *string
}
