...
// CustomerManagedKeyEncryption - Settings for customer-managed key encryption
type CustomerManagedKeyEncryption struct {
	// REQUIRED; Identity used to access the customer-managed key.
	KeyEncryptionKeyIdentity *KeyEncryptionKeyIdentity

	// REQUIRED; URL of the customer-managed key in Azure Key Vault.
...
type Encryption struct {
	// Optional Customer-managed key (CMK) encryption settings. If not provided, disks use platform-managed keys.
	CustomerManagedKeyEncryption *CustomerManagedKeyEncryption

	// Infrastructure-level encryption setting. Default is "disabled".
...
// KeyEncryptionKeyIdentity - Identity used to access the key vault
type KeyEncryptionKeyIdentity struct {
	// REQUIRED; Type of identity used to access the Key Vault.
	IdentityType *KeyEncryptionKeyIdentityType

	// Optional federated client ID for multi-tenant identity scenarios.
	FederatedClientID *string

	// Resource ID of the user-assigned managed identity, if used.
...
// * https://learn.microsoft.com/en-us/azure/virtual-machines/disk-encryption#encryption-at-host---end-to-end-encryption-for-your-vm-data
	...
	// Optional disk encryption settings for OS and data disks
