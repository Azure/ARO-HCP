...
func newVersionProfile(from *api.CustomerVersionProfile) generated.VersionProfile {
	if from == nil {
	...
	if c.Properties != nil {
		...
		if c.Properties != nil {
			...
			if c.Properties.DNS != nil {
				normalizeCustomerDNS(c.Properties.DNS, &out.CustomerProperties.DNS)
				normalizeServiceProviderDNS(c.Properties.DNS, &out.ServiceProviderProperties.DNS)
			}
			...
			if c.Properties.API != nil {
				normalizeCustomerAPI(c.Properties.API, &out.CustomerProperties.API)
				normalizeServiceProviderAPI(c.Properties.API, &out.ServiceProviderProperties.API)
			}
...
func normalizeVersion(p *generated.VersionProfile, out *api.CustomerVersionProfile) {
	if p.ID != nil {
		out.ID = *p.ID
	}
...
func normalizeCustomerDNS(p *generated.DNSProfile, out *api.CustomerDNSProfile) {
	if p.BaseDomainPrefix != nil {
		out.BaseDomainPrefix = *p.BaseDomainPrefix
	}
}

func normalizeServiceProviderDNS(p *generated.DNSProfile, out *api.ServiceProviderDNSProfile) {
	if p.BaseDomain != nil {
...
func normalizeCustomerAPI(p *generated.APIProfile, out *api.CustomerAPIProfile) {
	if p.Visibility != nil {
...
func normalizeServiceProviderAPI(p *generated.APIProfile, out *api.ServiceProviderAPIProfile) {
	if p.URL != nil {
		out.URL = *p.URL
	}
}
