...
//go:generate $MOCKGEN -typed -source=../../backend/pkg/azure/client/client_builder.go -destination=azure_client_builder.go -package mocks github.com/Azure/ARO-HCP/backend/pkg/azure/client FPAClientBuilder
