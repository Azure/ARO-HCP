...
//go:generate $MOCKGEN -typed -source=../database/crud_subscription.go -destination=crud_subscription.go -package mocks github.com/Azure/ARO-HCP/internal/database SubscriptionCRUD
...
//go:generate $MOCKGEN -typed -source=../../backend/pkg/azure/client/fpa_client_builder.go -destination=azure_fpa_client_builder.go -package mocks github.com/Azure/ARO-HCP/backend/pkg/azure/client FPAClientBuilder
