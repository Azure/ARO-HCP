...
func validateClusterCustomerProperties(ctx context.Context, op operation.Operation, fldPath *field.Path, newObj, oldObj *coreapi.HCPOpenShiftClusterCustomerProperties) field.ErrorList {
	...
	errs = append(errs, immutablePlatformExcludingMutableFields(ctx, op, fldPath.Child("platform"), &newObj.Platform, safe.Field(oldObj, toCustomerPlatform))...)
...
func immutablePlatformExcludingMutableFields(ctx context.Context, op operation.Operation, fldPath *field.Path, newObj *coreapi.CustomerPlatformProfile, oldObj *coreapi.CustomerPlatformProfile) field.ErrorList {
	var oldCopy *coreapi.CustomerPlatformProfile
	if oldObj != nil {
		tmp := *oldObj
