...
func createValidCluster() *api.HCPOpenShiftCluster {
	...
	// Set BillingDocID for valid testing (generated by admission on CREATE; immutable thereafter)
	cluster.ServiceProviderProperties.BillingDocID = "00000000-0000-0000-0000-000000000000"
