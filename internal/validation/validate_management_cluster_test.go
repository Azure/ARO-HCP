...
func validManagementCluster(t *testing.T) *fleet.ManagementCluster {
	t.Helper()
	resourceID := api.Must(fleet.ToManagementClusterResourceID("00000000-0000-0000-0000-000000000000", "rg", "pers-westus3-mgmt-1"))
...
func TestValidateManagementClusterUpdate(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			modify: func(t *testing.T, mc *fleet.ManagementCluster) {
				mc.ResourceID = api.Must(fleet.ToManagementClusterResourceID("11111111-1111-1111-1111-111111111111", "other-rg", "different-mgmt-1"))
			},
			expectErrors: []expectedError{
