...
// ImmutableByCompare is a copy of the k8s.io/apimachinery/pkg/api/validation.ImmutableByCompare function that
// was available until it was removed in k8s.io/apimachinery v0.35.0. We copied it here
// because we relied on it in our codebase already and we haven't changed to use
// a new approach more in line with what newer k8s.io/apimachinery versions do.
...
// ImmutableByReflect is a copy of the k8s.io/apimachinery/pkg/api/validation.ImmutableByReflect function that
// was available until it was removed in k8s.io/apimachinery v0.35.0. We copied it here
// because we relied on it in our codebase already and we haven't changed to use
// a new approach more in line with what newer k8s.io/apimachinery versions do.
