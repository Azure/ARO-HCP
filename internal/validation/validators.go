...
func ValidateNodePoolVersionChange(desiredVersion semver.Version, activeVersions []api.HCPNodePoolActiveVersion, lowestCPVersion, highestCPVersion *semver.Version, allowCrossMajorOperations bool) error {
	...
	err := ValidateNodePoolVersionSkew(desiredVersion, lowestCPVersion, highestCPVersion, allowCrossMajorOperations)
	if err != nil {
		return err
	}
...
func ValidateNodePoolVersionSkew(desiredVersion semver.Version, lowestCPVersion, highestCPVersion *semver.Version, allowCrossMajorOperations bool) error {
	...
	if lowestCPVersion == nil || highestCPVersion == nil {
		return fmt.Errorf("control plane active version is not populated")
	}
