...
require (
	github.com/Azure/ARO-Tools/config v0.0.0-20260617060128-2277df76598b // indirect
	github.com/Azure/ARO-Tools/testutil v0.0.0-20260617060128-2277df76598b // indirect
