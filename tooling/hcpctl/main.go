...
import (
	...
	"github.com/Azure/ARO-HCP/tooling/hcpctl/cmd/breakglass"
...
func main() {
	...
	cmd := &cobra.Command{
		Use:   "hcpctl",
		Short: "HCP Control CLI for ARO-HCP operations",
		Long: `hcpctl provides control plane tools for ARO-HCP operations.

This tool includes various subcommands for control plane operational tasks such as emergency
access (breakglass), cluster management, and diagnostic operations.`,
		SilenceUsage:     true,
		SilenceErrors:    true,
	...
	versionCmd := &cobra.Command{
		...
		Long:  "Display the version, commit SHA, and build date of hcpctl.",
		Run: func(cmd *cobra.Command, args []string) {
			fmt.Printf("hcpctl version %s\n", version)
