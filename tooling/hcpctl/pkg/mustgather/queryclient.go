...
type QueryClientInterface interface {
	ConcurrentQueries(ctx context.Context, queries []kusto.Query, outputChannel chan<- azkquery.Row) error
	Close() error
	ExecutePreconfiguredQuery(ctx context.Context, query kusto.Query, outputChannel chan<- azkquery.Row) (*kusto.QueryResult, error)
}
...
func (q *QueryClient) ConcurrentQueries(ctx context.Context, queries []kusto.Query, outputChannel chan<- azkquery.Row) error {
...
func (q *QueryClient) ExecutePreconfiguredQuery(ctx context.Context, query kusto.Query, outputChannel chan<- azkquery.Row) (*kusto.QueryResult, error) {
