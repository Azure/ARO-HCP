...
@register_command(
    "arohcp hcp-open-shift-cluster request-admin-credential",
)
class RequestAdminCredential(AAZCommand):
    """Request a temporary admin kubeconfig for the cluster

    :example: HcpOpenShiftClusters_RequestAdminCredential_MaximumSet
        az arohcp hcp-open-shift-cluster request-admin-credential --resource-group rgopenapi --hcp-open-shift-cluster-name hcpCluster-name
    """
