...
type Component struct {
	...
	ImageCreationTime        *time.Time `json:"imageCreationTime,omitempty" yaml:"imageCreationTime,omitempty"`
	RepoURL                  *string    `json:"RepoURL,omitempty" yaml:"RepoURL,omitempty"`
	SourceSHA                string     `json:"sourceSHA,omitempty" yaml:"sourceSHA,omitempty"`
	PermanentURLForSourceSHA *string    `json:"permanentURLForSourceSHA,omitempty" yaml:"permanentURLForSourceSHA,omitempty"`
}
...
func (rd *ReleaseDeployment) UnmarshalYAML(unmarshal func(any) error) error {
	...
	rd.Components = make(map[string]*Component)
