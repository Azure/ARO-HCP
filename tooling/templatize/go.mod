...
require (
	...
	github.com/Azure/ARO-Tools/tools/prow-job-executor v0.0.0-20260224202318-50897c5f99ec
	github.com/Azure/ARO-Tools/tools/registration v0.0.0-20260224202318-50897c5f99ec
