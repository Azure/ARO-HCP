...
require (
	github.com/Azure/ARO-Tools v0.0.0-20251020182809-035771c61e3d
...
replace helm.sh/helm/v4 => github.com/stevekuznetsov/helm/v4 v4.0.0-20251007172436-59349adca420
