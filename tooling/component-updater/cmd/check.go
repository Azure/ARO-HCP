...
func NewCheckCommand() *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:   "check",
		Short: "Show available version bumps without making changes",
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			results, err := updater.Check(ctx, cfg, configDir, subscriptionID, cred, components)
			if err != nil {
				return err
			}
	...
	cmd.Flags().StringSliceVar(&components, "component", nil, "specific components to check (default: all)")
