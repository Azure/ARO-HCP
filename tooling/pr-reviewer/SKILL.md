...
Review ARO-HCP changes as a high-signal teammate, not a generic linter. The goal is to surface the issues that matter for correctness, rollout safety, tenancy/security boundaries, generated artifacts, and operational behavior.
