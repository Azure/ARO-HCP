...
var _ = Describe("Create HCPOpenShiftCluster with CPO override (v20251223preview)", func() {
	It("should create a 4.20 cluster with CPO image override using v20251223preview API",
