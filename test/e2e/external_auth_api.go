...
var _ = Describe("External Auth API Access", Labels(labelsCombined), func() {
	...
	BeforeEach(func() {
		...
		clientID = ""     // TODO: wire in via Bicep params
		clientSecret = "" // TODO: wire in via Bicep params
		tenantID = ""     // TODO: wire in via Bicep params
		scope = ""        // TODO: wire in via Bicep params
		apiURL = ""       // TODO: wire in via Bicep params
