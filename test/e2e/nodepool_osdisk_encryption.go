...
var _ = Describe("Nodepool OS Disk Encryption", func() {
	It("should create a nodepool with customer-managed disk encryption via DES",
		...
		func(ctx context.Context) {
			...
			desResourceID, err := tc.CreateDiskEncryptionSet(ctx, *resourceGroup.Name, clusterParams.KeyVaultName, customerClusterName, *serviceMI.Properties.PrincipalID, tc.Location())
