...
var _ = Describe("Customer", func() {
	...
	It("should not be able to perform various invalid operations on cluster resources",
		...
		func(ctx context.Context) {
			...
			baseNodePoolParams := framework.NewDefaultNodePoolParams20251223()
			...
			if err != nil {
				...
				if nodePool.Properties.Platform.OSDisk != nil {
					...
					nodePool.Properties.Platform.OSDisk.DiskStorageAccountType = to.Ptr(hcpsdk20251223preview.DiskStorageAccountTypePremiumLRS)
				}
				...
				if err != nil {
					...
					if getErr != nil {
						...
						if platform.OSDisk != nil {
							...
							if platform.OSDisk.DiskStorageAccountType != nil && *platform.OSDisk.DiskStorageAccountType != hcpsdk20251223preview.DiskStorageAccountTypeStandardSSDLRS {
