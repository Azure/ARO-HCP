...
var _ = Describe("Customer", func() {
	...
	It("should be able to create an HCP cluster with a customer managed KMS key for etcd",
		...
		func(ctx context.Context) {
			...
			By("creating the hcp cluster with  customer managed KMS key for etcd")
			...
			_, err = framework.CreateBicepTemplateAndWait(ctx,
				...
				*resourceGroup.Name,
				"hcp-cluster",
				framework.Must(TestArtifactsFS.ReadFile("test-artifacts/generated-test-artifacts/customer-managed-kms-etcd/customer-managed-kms-etcd-cluster.json")),
				map[string]interface{}{
