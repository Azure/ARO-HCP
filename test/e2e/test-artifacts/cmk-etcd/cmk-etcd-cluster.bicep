...
// K E Y V A U L T
//
module clusterEtcdKeyVault '../../../../dev-infrastructure/modules/keyvault/keyvault.bicep' = {
  name: 'etcd-kv-${clusterName}'
...
module encryptionKey '../../../../dev-infrastructure/modules/keyvault/key-vault-key.bicep' = {
