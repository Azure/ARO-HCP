...
var _ = Describe("Customer", func() {
	...
	It("should be able to create an HCP cluster with Image Registry not present",
		...
		func(ctx context.Context) {
			...
			Expect(ptr.Deref(actualHCPCluster.Properties.ClusterImageRegistry.State, "")).To(Equal(hcpsdk20260901preview.ClusterImageRegistryStateDisabled), "cluster image registry state should be Disabled")
