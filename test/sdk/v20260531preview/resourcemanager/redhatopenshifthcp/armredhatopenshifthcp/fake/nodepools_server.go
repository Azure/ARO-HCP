...
import (
	...
	"github.com/Azure/ARO-HCP/test/sdk/v20260531preview/resourcemanager/redhatopenshifthcp/armredhatopenshifthcp"
)
...
func (n *NodePoolsServerTransport) dispatchBeginUpdate(req *http.Request) (*http.Response, error) {
	...
	if beginUpdate == nil {
		...
		body, err := server.UnmarshalRequestAsJSON[armredhatopenshifthcp.NodePoolUpdate](req)
		if err != nil {
			return nil, err
		}
		resourceGroupNameParam, err := url.PathUnescape(matches[regex.SubexpIndex("resourceGroupName")])
