...
type KmsEncryptionProfile struct {
	// REQUIRED; The versioned URL of the key used for ETCD data encryption. Format: https://{vault-name}.{vault-domain}/keys/{key-name}/{key-version}
...
type KmsEncryptionProfileUpdate struct {
	// The versioned URL of the key used for ETCD data encryption. Format: https://{vault-name}.{vault-domain}/keys/{key-name}/{key-version}
	KeyEncryptionKeyURL *string
}
