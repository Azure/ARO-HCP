...
func CreateClusterWithBicep(ctx context.Context, bicepJSONFile string, resourceGroupName string, deploymentsClient *armresources.DeploymentsClient, clientFactory *hcpsdk.ClientFactory) (SetupModel, error) {
