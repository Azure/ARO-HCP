...
func FallbackCreateClusterWithBicep(ctx context.Context, bicepJSONFileName string) (SetupModel, error) {
	...
	deploymentResult, err := tc.CreateBicepTemplateAndWait(ctx,
		...
		framework.WithClusterResourceGroup(resourceGroupName),
	...
	// Convert userAssignedIdentitiesValue to hcpsdk20251223preview.UserAssignedIdentitiesProfile
	...
	// Convert identityValue to hcpsdk20251223preview.ManagedServiceIdentity
	identityUAMIs := hcpsdk20251223preview.ManagedServiceIdentity{}
	...
	var clusterData hcpsdk20251223preview.HcpOpenShiftCluster
	if err != nil {
	...
	var nodepoolData hcpsdk20251223preview.NodePool
	if err != nil {
