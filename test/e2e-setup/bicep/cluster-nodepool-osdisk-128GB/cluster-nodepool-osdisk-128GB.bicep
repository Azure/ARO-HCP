...
@description('OpenShift Version ID to use for cluster')
param openshiftVersionId string = '4.19'

@description('OpenShift Version ID to use for nodepool')
param nodepoolOpenshiftVersionId string = '4.19.0'

@description('The name of the node pool')
param nodePoolName string = 'nodepool-128GiB'
...
// Service managed identity reader role assignments on control plane managed identities
...
// Federated credentials role assignments for dataplane identities
...
var userAssignedIdentitiesValue = {
