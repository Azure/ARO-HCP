...
convert_bicep_to_json "${project_root}/test/e2e/test-artifacts/external-auth/external-auth-cluster.bicep" "${OUTPUT_DIR}/external-auth/external-auth-new-cluster.json"
