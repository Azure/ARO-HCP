...
func NewCommand() (*cobra.Command, error) {
	...
	cmd := &cobra.Command{
		Use:           "gather-snapshot",
		Short:         "Gather diagnostic snapshots for e2e test runs and produce jUnit/HTML artifacts.",
		SilenceErrors: true,
		SilenceUsage:  true,
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			return GatherSnapshot(cmd.Context(), opts)
		},
	}
...
func GatherSnapshot(ctx context.Context, opts *RawOptions) error {
