...
declare -a DIGEST_PATHS=(
  ...
  "maestro.agent.sidecar.image.digest"
  "mise.image.digest"
  "mgmt.prometheus.kubeStateMetrics.image.digest"
  "mgmt.prometheus.prometheusConfigReloader.image.sha"
  "mgmt.prometheus.prometheusOperator.image.sha"
  "mgmt.prometheus.prometheusSpec.image.sha"
  "pko.imageManager.digest"
  "pko.imagePackage.digest"
  "pko.remotePhaseManager.digest"
  "secretSyncController.image.digest"
  "svc.prometheus.kubeStateMetrics.image.digest"
  "svc.prometheus.prometheusConfigReloader.image.sha"
  "svc.prometheus.prometheusOperator.image.sha"
  "svc.prometheus.prometheusSpec.image.sha"
)
