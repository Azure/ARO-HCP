...
type syncClusterUpdateDispatchStep struct {
	stepID StepID
	key    controllerutils.HCPClusterKey
}

func newSyncClusterUpdateDispatchStep(stepID StepID, stepDir fs.FS) (*syncClusterUpdateDispatchStep, error) {
	...
	return &syncClusterUpdateDispatchStep{
		stepID: stepID,
		key: controllerutils.HCPClusterKey{
...
var _ IntegrationTestStep = &syncClusterUpdateDispatchStep{}

func (s *syncClusterUpdateDispatchStep) StepID() StepID {
	return s.stepID
}

func (s *syncClusterUpdateDispatchStep) RunTest(ctx context.Context, t *testing.T, stepInput StepInput) {
	require.NotNil(t, stepInput.ClusterServiceMockInfo, "syncClusterUpdateDispatch requires a ClusterServiceMock")
