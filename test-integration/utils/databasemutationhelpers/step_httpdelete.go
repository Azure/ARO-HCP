...
func newHTTPDeleteStep(stepID StepID, stepDir fs.FS) (*httpDeleteStep, error) {
...
var _ IntegrationTestStep = &httpDeleteStep{}

func (l *httpDeleteStep) StepID() StepID {
	return l.stepID
}
