...
func ResourceInstanceEquals(t *testing.T, expected, actual any) (string, bool) {
	...
	for _, currMap := range []map[string]any{expectedMap, actualMap} {
		...
		for _, possiblePrepend := range []string{"", "properties"} {
			...
			unstructured.RemoveNestedField(currMap, prepend(possiblePrepend, "internalState", "internalAPI", "serviceProviderProperties", "activeOperationId")...) // cluster - UUID generated
			unstructured.RemoveNestedField(currMap, prepend(possiblePrepend, "internalState", "internalAPI", "serviceProviderProperties", "clusterServiceID")...)  // cluster - randomly generated by cluster-service mock
			unstructured.RemoveNestedField(currMap, prepend(possiblePrepend, "internalState", "internalAPI", "systemData", "createdAt")...)                        // cluster - varies on every run
			unstructured.RemoveNestedField(currMap, prepend(possiblePrepend, "internalState", "internalAPI", "systemData", "lastModifiedAt")...)                   // cluster - varies on every run
			...
			// inline serialization on cluster also exposes these UUID-generated / variable fields directly under properties
			unstructured.RemoveNestedField(currMap, prepend(possiblePrepend, "serviceProviderProperties", "clusterUID")...)        // UUID generated
			unstructured.RemoveNestedField(currMap, prepend(possiblePrepend, "serviceProviderProperties", "activeOperationId")...) // UUID generated
			unstructured.RemoveNestedField(currMap, prepend(possiblePrepend, "serviceProviderProperties", "clusterServiceID")...)  // randomly generated by cluster-service mock
