...
func ResourceInstanceEquals(t *testing.T, expected, actual any) (string, bool) {
	...
	for _, currMap := range []map[string]any{expectedMap, actualMap} {
		...
		for _, possiblePrepend := range []string{"", "properties"} {
			...
			unstructured.RemoveNestedField(currMap, prepend(possiblePrepend, "internalState", "internalAPI", "serviceProviderProperties", "activeOperationId")...)                 // cluster, nodepool, externalauth - UUID generated
			unstructured.RemoveNestedField(currMap, prepend(possiblePrepend, "internalState", "internalAPI", "serviceProviderProperties", "clusterServiceID")...)                  // cluster, nodepool, externalauth - randomly generated by cluster-service mock
			unstructured.RemoveNestedField(currMap, prepend(possiblePrepend, "internalState", "internalAPI", "serviceProviderProperties", "deletionTimestamp")...)                 // nodepool - timestamp at which the NodePool deletion was requested - varies on every run on delete
			unstructured.RemoveNestedField(currMap, prepend(possiblePrepend, "internalState", "internalAPI", "serviceProviderProperties", "createOperationCompletionDeadline")...) // cluster, nodepool - deadline computed from time.Now() - varies on every run on create
			unstructured.RemoveNestedField(currMap, prepend(possiblePrepend, "internalState", "internalAPI", "systemData", "createdAt")...)                                        // cluster, nodepool, externalauth - varies on every run
			unstructured.RemoveNestedField(currMap, prepend(possiblePrepend, "internalState", "internalAPI", "systemData", "lastModifiedAt")...)                                   // cluster, nodepool, externalauth - varies on every run
			unstructured.RemoveNestedField(currMap, prepend(possiblePrepend, "internalState", "internalAPI", "cosmosMetadata")...)                                                 // cluster, nodepool, externalauth - redundant copy of inline cosmosMetadata
			unstructured.RemoveNestedField(currMap, prepend(possiblePrepend, "cosmosMetadata", "etag")...)

			// inline serialization (cluster, nodepool, externalauth) also exposes these UUID-generated / variable fields directly under properties
			unstructured.RemoveNestedField(currMap, prepend(possiblePrepend, "serviceProviderProperties", "clusterUID")...)                        // cluster - UUID generated
			unstructured.RemoveNestedField(currMap, prepend(possiblePrepend, "serviceProviderProperties", "activeOperationId")...)                 // cluster, nodepool, externalauth - UUID generated
			unstructured.RemoveNestedField(currMap, prepend(possiblePrepend, "serviceProviderProperties", "clusterServiceID")...)                  // cluster, nodepool, externalauth - randomly generated by cluster-service mock
			unstructured.RemoveNestedField(currMap, prepend(possiblePrepend, "serviceProviderProperties", "deletionTimestamp")...)                 // nodepool - timestamp at which the NodePool deletion was requested - varies on every run on delete
			unstructured.RemoveNestedField(currMap, prepend(possiblePrepend, "serviceProviderProperties", "createOperationCompletionDeadline")...) // cluster, nodepool - deadline computed from time.Now() - varies on every run on create
			unstructured.RemoveNestedField(currMap, prepend(possiblePrepend, "systemData", "createdAt")...)
			unstructured.RemoveNestedField(currMap, prepend(possiblePrepend, "systemData", "lastModifiedAt")...)
