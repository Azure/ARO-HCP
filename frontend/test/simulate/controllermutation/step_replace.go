...
func newReplaceStep(stepID stepID, cosmosContainer *azcosmos.ContainerClient, stepDir fs.FS) (*replaceStep, error) {
...
var _ controllerMutationStep = &replaceStep{}

func (l *replaceStep) StepID() stepID {
	return l.stepID
}

func (l *replaceStep) RunTest(ctx context.Context, t *testing.T) {
	...
	_, err = controllerCRUDClient.Replace(ctx, l.controller, nil)
