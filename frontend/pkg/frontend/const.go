...
const (
	...
	errLocationFailedBuildingCSCluster            = "failed building cluster service cluster"
	errLocationFailedBuildingCSExternalAuth       = "failed building cluster service external auth"
	errLocationFailedBuildingCSNodePool           = "failed building cluster service node pool"
	...
	errLocationFailedConvertingFromCSCluster      = "failed converting from cluster service cluster"
	errLocationFailedConvertingFromCSExternalAuth = "failed converting from cluster service external auth"
	errLocationFailedConvertingFromCSNodePool     = "failed converting from cluster service node pool"
	errLocationFailedCreatingCSID                 = "failed during delegation ID creation"
	...
	errLocationUnknownCSError                     = "unknown cluster service error type"
