...
func TestMiddlewareResourceID(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			path: "/SUBSCRIPTIONS/00000000-0000-0000-0000-000000000000/PROVIDERS/MICROSOFT.REDHATOPENSHIFT/LOCATIONS/eastus/HCPOPERATIONSSTATUSES/11111111-1111-1111-1111-111111111111",
			resourceTypes: []string{
				"MICROSOFT.REDHATOPENSHIFT/LOCATIONS/HCPOPERATIONSSTATUSES",
