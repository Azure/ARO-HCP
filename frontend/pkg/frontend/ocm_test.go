...
func withOCMDisabledCapabilities(values ...string) func(*arohcpv1alpha1.ClusterBuilder) *arohcpv1alpha1.ClusterBuilder {
	var occs []arohcpv1alpha1.OptionalClusterCapability
	for _, value := range values {
		occs = append(occs, arohcpv1alpha1.OptionalClusterCapability(value))
	}
	return func(b *arohcpv1alpha1.ClusterBuilder) *arohcpv1alpha1.ClusterBuilder {
		return b.Capabilities(arohcpv1alpha1.NewClusterCapabilities().Disabled(occs...))
	}
}
