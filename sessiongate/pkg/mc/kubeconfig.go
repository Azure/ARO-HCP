...
func GetHostedClusterRESTConfig(ctx context.Context, mgmtRestConfig *rest.Config, hcpInfo HCPInfo, user string, accessGroup string) (*rest.Config, error) {
	...
	subject := hcp.BuildSubject(user, accessGroup)
