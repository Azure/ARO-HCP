...
type fakeSessions struct {
	*gentype.FakeClientWithList[*v1alpha1.Session, *v1alpha1.SessionList]
	Fake *FakeSessiongateV1alpha1
}

func newFakeSessions(fake *FakeSessiongateV1alpha1, namespace string) sessiongatev1alpha1.SessionInterface {
	return &fakeSessions{
		gentype.NewFakeClientWithList[*v1alpha1.Session, *v1alpha1.SessionList](
			fake.Fake,
			namespace,
