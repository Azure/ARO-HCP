...
// ManagementClusterApplyConfiguration constructs a declarative configuration of the ManagementCluster type for use with
// apply.
func ManagementCluster() *ManagementClusterApplyConfiguration {
	return &ManagementClusterApplyConfiguration{}
}
...
func (b *ManagementClusterApplyConfiguration) WithResourceID(value string) *ManagementClusterApplyConfiguration {
	b.ResourceID = &value
	return b
}
