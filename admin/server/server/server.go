...
func (a *AdminAPI) Handlers() http.Handler {
	...
	return middleware.WithClientPrincipal(middleware.WithLowercaseURLPathValue(middleware.WithLogger(a.logger, rootMux)))
}
