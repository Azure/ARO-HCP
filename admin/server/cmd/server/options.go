...
func (o *ValidatedOptions) Complete(ctx context.Context) (*Options, error) {
	...
	var fpaCredentialRetriever fpa.FirstPartyApplicationTokenCredentialRetriever
	if o.FpaClientID != "" && o.FpaCertBundlePath != "" {
...
func (opts *Options) Run(ctx context.Context) error {
	...
	v1HCPMux.Handle("GET", "/helloworld", hcp.HCPHelloWorld(opts.DbClient, opts.FpaCredentialRetriever))
