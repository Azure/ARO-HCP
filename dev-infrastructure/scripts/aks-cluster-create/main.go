...
// pools on an already-running cluster. Subsequent runs reconcile cluster
// configuration without modifying fleet-owned pools or the Kubernetes version.
//
...
func main() {
	...
	if err := completed.run(ctx, logger); err != nil {
