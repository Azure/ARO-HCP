...
param newInfraAgentMinCount = {{ .mgmt.aks.newInfraAgentPool.minCount }}
param newInfraAgentMaxCount = {{ .mgmt.aks.newInfraAgentPool.maxCount }}
param newInfraAgentVMSize = '{{ .mgmt.aks.newInfraAgentPool.vmSize }}'
param newInfraAgentPoolCount = {{ .mgmt.aks.newInfraAgentPool.poolCount }}
param newInfraAgentPoolZones = '{{ .mgmt.aks.newInfraAgentPool.zones }}'
param newInfraOsDiskSizeGB = {{ .mgmt.aks.newInfraAgentPool.osDiskSizeGB }}
param newInfraZoneRedundantMode = '{{ .mgmt.aks.newInfraAgentPool.zoneRedundantMode }}'
