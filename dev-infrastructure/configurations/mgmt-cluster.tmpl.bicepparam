...
param userSwiftAgentPoolName = '{{ .mgmt.aks.userSwiftAgentPool.name }}'
param userSwiftAgentMinCount = {{ .mgmt.aks.userSwiftAgentPool.minCount }}
param userSwiftAgentMaxCount = {{ .mgmt.aks.userSwiftAgentPool.maxCount }}
param userSwiftAgentVMSize = '{{ .mgmt.aks.userSwiftAgentPool.vmSize }}'
param userSwiftAgentPoolCount = {{ .mgmt.aks.userSwiftAgentPool.poolCount }}
param userSwiftAgentPoolZones = '{{ .mgmt.aks.userSwiftAgentPool.zones }}'
param userSwiftZoneRedundantMode = '{{ .mgmt.aks.userSwiftAgentPool.zoneRedundantMode }}'
param userSwiftSecondaryNicCount = {{ .mgmt.aks.userSwiftAgentPool.secondaryNicCount }}
