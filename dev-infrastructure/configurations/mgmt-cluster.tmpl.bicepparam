...
param infraBAgentMinCount = {{ .mgmt.aks.infraAgentPoolB.minCount }}
param infraBAgentMaxCount = {{ .mgmt.aks.infraAgentPoolB.maxCount }}
param infraBAgentVMSize = '{{ .mgmt.aks.infraAgentPoolB.vmSize }}'
param infraBAgentPoolCount = {{ .mgmt.aks.infraAgentPoolB.poolCount }}
param infraBAgentPoolZones = '{{ .mgmt.aks.infraAgentPoolB.zones }}'
param infraBOsDiskSizeGB = {{ .mgmt.aks.infraAgentPoolB.osDiskSizeGB }}
param infraBZoneRedundantMode = '{{ .mgmt.aks.infraAgentPoolB.zoneRedundantMode }}'
