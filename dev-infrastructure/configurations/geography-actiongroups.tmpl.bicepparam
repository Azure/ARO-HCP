using '../templates/geography-actiongroups.bicep'
...
param icmActionGroupNameDEV = '{{ .monitoring.icm.dev.actionGroupName }}'
param icmActionGroupShortNameDEV = '{{ .monitoring.icm.dev.actionGroupShortName }}'
param icmRoutingIdDEV = '{{ .monitoring.icm.dev.routingId }}'
param icmAutomitigationEnabledDEV = '{{ .monitoring.icm.dev.automitigationEnabled }}'
