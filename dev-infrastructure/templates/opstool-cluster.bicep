...
@description('Maximum active time series limit for Azure Monitor Workspace (10M for 100 HCPs, max 20M via API)')
param amwMaxActiveTimeSeries int = 10000000

@description('Maximum events per minute limit for Azure Monitor Workspace (10M for 100 HCPs, max 20M via API)')
