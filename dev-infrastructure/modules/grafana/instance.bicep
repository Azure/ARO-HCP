...
resource grafanaManagerContributor 'Microsoft.Authorization/roleAssignments@2022-04-01' = {
  name: guid(grafana.id, grafanaManagerPrincipalId, grafanaBuiltInRoles.Contributor)
  scope: grafana
  properties: {
    principalId: grafanaManagerPrincipalId
    principalType: 'ServicePrincipal'
    roleDefinitionId: subscriptionResourceId('Microsoft.Authorization/roleDefinitions', grafanaBuiltInRoles.Contributor)
  }
}
