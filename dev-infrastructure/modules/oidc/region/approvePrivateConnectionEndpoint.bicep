...
var privateEndpoint = [for conn in privateConnections: {
...
resource privateConnection 'Microsoft.Storage/storageAccounts/privateEndpointConnections@2023-01-01' = [for endpoint in privateEndpoint: if (endpoint.status != 'Approved' && endpoint.description==requestMessage) {
  name: endpoint.name
