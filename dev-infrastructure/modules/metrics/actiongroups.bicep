...
@description('Indicates if alerting should be disabled for this region. When true, action groups will be disabled.')
param alertingDisabled bool

resource icmsre 'Microsoft.Insights/actionGroups@2024-10-01-preview' = {
  name: 'icm-action-group-sre'
  location: 'global'
  properties: {
    enabled: !alertingDisabled
