    ...
    rules: [
      {
        ...
        expression: 'sum by (cluster, namespace, region) (rate(konnectivity_network_proxy_server_stream_errors_total[5m])) / sum by (cluster, namespace, region) (rate(konnectivity_network_proxy_server_stream_packets_total[5m]))'
      }
      {
      ...
      }
      {
        ...
        expression: 'sum by (cluster, namespace, region) (rate(konnectivity_network_proxy_server_dial_failure_count[5m])) / (sum by (cluster, namespace, region) (rate(konnectivity_network_proxy_server_dial_failure_count[5m])) + sum by (cluster, namespace, region) (rate(konnectivity_network_proxy_server_stream_packets_total{packet_type="DIAL_RSP",segment="from_agent"}[5m])))'
      }
      {
