    ...
    rules: [
      {
        ...
        annotations: {
          correlationId: 'SwiftCNSAvailability3d/{{ $labels.cluster }}'
    ...
    rules: [
      {
        ...
        annotations: {
          correlationId: 'SwiftPendingProgramming/{{ $labels.cluster }}'
