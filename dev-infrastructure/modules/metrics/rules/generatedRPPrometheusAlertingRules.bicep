    ...
    rules: [
      {
        ...
        annotations: {
          ...
          title: '{{ $labels.cluster }}: Cluster create operation for {{ $labels.resource_id }} stuck in {{ $labels.phase }} for over 30 minutes'
        }
    ...
    rules: [
      {
        ...
        annotations: {
          ...
          runbook_url: 'aka.ms/cluster-deletion-tsg'
