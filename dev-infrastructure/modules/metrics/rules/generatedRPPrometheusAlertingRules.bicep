...
'''
        ...
        expression: 'hosted_control_plane_version:desired:stuck_over_20m:burnrate5m > 14.4 and hosted_control_plane_version:desired:stuck_over_20m:burnrate1h > 14.4'
        for: 'PT5M'
        severity: severityCeiling > 0 ? max(4, severityCeiling) : 4
      }
      {
...
'''
        ...
        expression: 'hosted_control_plane_version:desired:stuck_over_20m:burnrate30m > 6 and hosted_control_plane_version:desired:stuck_over_20m:burnrate6h > 6'
        for: 'PT30M'
        severity: severityCeiling > 0 ? max(4, severityCeiling) : 4
      }
      {
...
'''
        ...
        expression: 'hosted_control_plane_version:desired:stuck_over_20m:burnrate6h > 1 and hosted_control_plane_version:desired:stuck_over_20m:burnrate3d > 1'
        for: 'PT30M'
        severity: severityCeiling > 0 ? max(4, severityCeiling) : 4
      }
    ]
...
'''
        ...
        expression: 'hosted_control_plane_version:in_progress:stuck_over_30m:burnrate5m > 14.4 and hosted_control_plane_version:in_progress:stuck_over_30m:burnrate1h > 14.4'
        for: 'PT5M'
        severity: severityCeiling > 0 ? max(4, severityCeiling) : 4
      }
      {
...
'''
        ...
        expression: 'hosted_control_plane_version:in_progress:stuck_over_30m:burnrate30m > 6 and hosted_control_plane_version:in_progress:stuck_over_30m:burnrate6h > 6'
        for: 'PT30M'
        severity: severityCeiling > 0 ? max(4, severityCeiling) : 4
      }
      {
...
'''
        ...
        expression: 'hosted_control_plane_version:in_progress:stuck_over_30m:burnrate6h > 1 and hosted_control_plane_version:in_progress:stuck_over_30m:burnrate3d > 1'
        for: 'PT30M'
        severity: severityCeiling > 0 ? max(4, severityCeiling) : 4
      }
    ]
