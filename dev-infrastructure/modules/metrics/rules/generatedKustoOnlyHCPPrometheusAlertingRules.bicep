    ...
    rules: [
      {
        ...
        expression: 'max_over_time(kube_pod_container_status_waiting_reason{job="kube-state-metrics",namespace=~"ocm-.*",reason="CrashLoopBackOff"}[5m]) >= 1'
        for: 'PT15M'
      ...
      }
      {
        ...
        expression: 'kube_deployment_status_observed_generation{job="kube-state-metrics",namespace=~"ocm-.*"} != kube_deployment_metadata_generation{job="kube-state-metrics",namespace=~"ocm-.*"}'
        for: 'PT15M'
        severity: severityCeiling > 0 ? max(3, severityCeiling) : 3
      }
      {
        ...
        expression: '(kube_deployment_spec_replicas{job="kube-state-metrics",namespace=~"ocm-.*"} > kube_deployment_status_replicas_available{job="kube-state-metrics",namespace=~"ocm-.*"}) and (changes(kube_deployment_status_replicas_updated{job="kube-state-metrics",namespace=~"ocm-.*"}[10m]) == 0)'
        for: 'PT30M'
        severity: severityCeiling > 0 ? max(3, severityCeiling) : 3
      }
      {
        ...
        expression: 'kube_deployment_status_condition{condition="Progressing",job="kube-state-metrics",namespace=~"ocm-.*",status="false"} != 0'
        for: 'PT30M'
        severity: severityCeiling > 0 ? max(3, severityCeiling) : 3
      }
      {
        ...
        expression: '(kube_statefulset_status_replicas_ready{job="kube-state-metrics",namespace=~"ocm-.*"} != kube_statefulset_status_replicas{job="kube-state-metrics",namespace=~"ocm-.*"}) and (changes(kube_statefulset_status_replicas_updated{job="kube-state-metrics",namespace=~"ocm-.*"}[10m]) == 0)'
        for: 'PT15M'
        severity: severityCeiling > 0 ? max(3, severityCeiling) : 3
      }
      {
        ...
        expression: 'kube_statefulset_status_observed_generation{job="kube-state-metrics",namespace=~"ocm-.*"} != kube_statefulset_metadata_generation{job="kube-state-metrics",namespace=~"ocm-.*"}'
        for: 'PT15M'
        severity: severityCeiling > 0 ? max(3, severityCeiling) : 3
      }
      {
        ...
        expression: '(max by (namespace, statefulset, job, cluster) (kube_statefulset_status_current_revision{job="kube-state-metrics",namespace=~"ocm-.*"} unless kube_statefulset_status_update_revision{job="kube-state-metrics",namespace=~"ocm-.*"}) * (kube_statefulset_replicas{job="kube-state-metrics",namespace=~"ocm-.*"} != kube_statefulset_status_replicas_updated{job="kube-state-metrics",namespace=~"ocm-.*"})) and (changes(kube_statefulset_status_replicas_updated{job="kube-state-metrics",namespace=~"ocm-.*"}[5m]) == 0)'
        for: 'PT15M'
        severity: severityCeiling > 0 ? max(3, severityCeiling) : 3
      }
      {
        ...
        expression: '((kube_daemonset_status_current_number_scheduled{job="kube-state-metrics",namespace=~"ocm-.*"} != kube_daemonset_status_desired_number_scheduled{job="kube-state-metrics",namespace=~"ocm-.*"}) or (kube_daemonset_status_number_misscheduled{job="kube-state-metrics",namespace=~"ocm-.*"} != 0) or (kube_daemonset_status_updated_number_scheduled{job="kube-state-metrics",namespace=~"ocm-.*"} != kube_daemonset_status_desired_number_scheduled{job="kube-state-metrics",namespace=~"ocm-.*"}) or (kube_daemonset_status_number_available{job="kube-state-metrics",namespace=~"ocm-.*"} != kube_daemonset_status_desired_number_scheduled{job="kube-state-metrics",namespace=~"ocm-.*"})) and (changes(kube_daemonset_status_updated_number_scheduled{job="kube-state-metrics",namespace=~"ocm-.*"}[5m]) == 0)'
        for: 'PT15M'
        severity: severityCeiling > 0 ? max(3, severityCeiling) : 3
      }
      {
        ...
        expression: 'sum by (namespace, pod, container, cluster) (kube_pod_container_status_waiting_reason{job="kube-state-metrics",namespace=~"ocm-.*"}) > 0'
        for: 'PT1H'
        severity: severityCeiling > 0 ? max(3, severityCeiling) : 3
      }
      {
        ...
        expression: 'kube_daemonset_status_desired_number_scheduled{job="kube-state-metrics",namespace=~"ocm-.*"} - kube_daemonset_status_current_number_scheduled{job="kube-state-metrics",namespace=~"ocm-.*"} > 0'
        for: 'PT10M'
        severity: severityCeiling > 0 ? max(3, severityCeiling) : 3
      }
      {
        ...
        expression: 'kube_daemonset_status_number_misscheduled{job="kube-state-metrics",namespace=~"ocm-.*"} > 0'
        for: 'PT15M'
        severity: severityCeiling > 0 ? max(3, severityCeiling) : 3
      }
      {
        ...
        expression: 'time() - max by (namespace, job_name, cluster) (kube_job_status_start_time{job="kube-state-metrics",namespace=~"ocm-.*"} and kube_job_status_active{job="kube-state-metrics",namespace=~"ocm-.*"} > 0) > 43200'
        severity: severityCeiling > 0 ? max(3, severityCeiling) : 3
      }
      {
        actions: [
        ...
        expression: 'kube_job_failed{job="kube-state-metrics",namespace=~"ocm-.*"} > 0'
        for: 'PT15M'
        severity: severityCeiling > 0 ? max(3, severityCeiling) : 3
      }
      {
        ...
        expression: '(kube_horizontalpodautoscaler_status_desired_replicas{job="kube-state-metrics",namespace=~"ocm-.*"} != kube_horizontalpodautoscaler_status_current_replicas{job="kube-state-metrics",namespace=~"ocm-.*"}) and (kube_horizontalpodautoscaler_status_current_replicas{job="kube-state-metrics",namespace=~"ocm-.*"} > kube_horizontalpodautoscaler_spec_min_replicas{job="kube-state-metrics",namespace=~"ocm-.*"}) and (kube_horizontalpodautoscaler_status_current_replicas{job="kube-state-metrics",namespace=~"ocm-.*"} < kube_horizontalpodautoscaler_spec_max_replicas{job="kube-state-metrics",namespace=~"ocm-.*"}) and changes(kube_horizontalpodautoscaler_status_current_replicas{job="kube-state-metrics",namespace=~"ocm-.*"}[15m]) == 0'
        for: 'PT15M'
        severity: severityCeiling > 0 ? max(3, severityCeiling) : 3
      }
      {
        ...
        expression: 'kube_horizontalpodautoscaler_status_current_replicas{job="kube-state-metrics",namespace=~"ocm-.*"} == kube_horizontalpodautoscaler_spec_max_replicas{job="kube-state-metrics",namespace=~"ocm-.*"}'
        for: 'PT15M'
        severity: severityCeiling > 0 ? max(3, severityCeiling) : 3
      }
    ]
    ...
    rules: [
      {
        ...
        expression: 'sum by (cluster) (namespace_cpu:kube_pod_container_resource_requests:sum{namespace=~"ocm-.*"}) - (sum by (cluster) (kube_node_status_allocatable{job="kube-state-metrics",namespace=~"ocm-.*",resource="cpu"}) - max by (cluster) (kube_node_status_allocatable{job="kube-state-metrics",namespace=~"ocm-.*",resource="cpu"})) > 0 and (sum by (cluster) (kube_node_status_allocatable{job="kube-state-metrics",namespace=~"ocm-.*",resource="cpu"}) - max by (cluster) (kube_node_status_allocatable{job="kube-state-metrics",namespace=~"ocm-.*",resource="cpu"})) > 0'
        for: 'PT10M'
        severity: severityCeiling > 0 ? max(3, severityCeiling) : 3
      }
      {
        ...
        expression: 'sum by (cluster) (namespace_memory:kube_pod_container_resource_requests:sum{namespace=~"ocm-.*"}) - (sum by (cluster) (kube_node_status_allocatable{job="kube-state-metrics",namespace=~"ocm-.*",resource="memory"}) - max by (cluster) (kube_node_status_allocatable{job="kube-state-metrics",namespace=~"ocm-.*",resource="memory"})) > 0 and (sum by (cluster) (kube_node_status_allocatable{job="kube-state-metrics",namespace=~"ocm-.*",resource="memory"}) - max by (cluster) (kube_node_status_allocatable{job="kube-state-metrics",namespace=~"ocm-.*",resource="memory"})) > 0'
        for: 'PT10M'
        severity: severityCeiling > 0 ? max(3, severityCeiling) : 3
      }
      {
        ...
        expression: 'sum by (cluster) (min without (resource) (kube_resourcequota{job="kube-state-metrics",namespace=~"ocm-.*",resource=~"(cpu|requests.cpu)",type="hard"})) / sum by (cluster) (kube_node_status_allocatable{job="kube-state-metrics",namespace=~"ocm-.*",resource="cpu"}) > 1.5'
        for: 'PT5M'
        severity: severityCeiling > 0 ? max(3, severityCeiling) : 3
      }
      {
        ...
        expression: 'sum by (cluster) (min without (resource) (kube_resourcequota{job="kube-state-metrics",namespace=~"ocm-.*",resource=~"(memory|requests.memory)",type="hard"})) / sum by (cluster) (kube_node_status_allocatable{job="kube-state-metrics",namespace=~"ocm-.*",resource="memory"}) > 1.5'
        for: 'PT5M'
        severity: severityCeiling > 0 ? max(3, severityCeiling) : 3
      }
      {
        ...
        expression: 'kube_resourcequota{job="kube-state-metrics",namespace=~"ocm-.*",type="used"} / ignoring (instance, job, type) (kube_resourcequota{job="kube-state-metrics",namespace=~"ocm-.*",type="hard"} > 0) > 0.9 < 1'
        for: 'PT15M'
      ...
      }
      {
        ...
        expression: 'kube_resourcequota{job="kube-state-metrics",namespace=~"ocm-.*",type="used"} / ignoring (instance, job, type) (kube_resourcequota{job="kube-state-metrics",namespace=~"ocm-.*",type="hard"} > 0) == 1'
        for: 'PT15M'
        severity: severityCeiling > 0 ? max(4, severityCeiling) : 4
      }
      {
      ...
      }
      {
        ...
        expression: 'sum by (cluster, container, pod, namespace) (increase(container_cpu_cfs_throttled_periods_total{container!="",namespace=~"ocm-.*"}[5m])) / sum by (cluster, container, pod, namespace) (increase(container_cpu_cfs_periods_total{namespace=~"ocm-.*"}[5m])) > (25 / 100)'
        for: 'PT15M'
        severity: severityCeiling > 0 ? max(4, severityCeiling) : 4
      }
    ]
    ...
    rules: [
      {
        ...
        expression: '(kubelet_volume_stats_available_bytes{job="kubelet",metrics_path="/metrics",namespace=~"ocm-.*"} / kubelet_volume_stats_capacity_bytes{job="kubelet",metrics_path="/metrics",namespace=~"ocm-.*"}) < 0.03 and kubelet_volume_stats_used_bytes{job="kubelet",metrics_path="/metrics",namespace=~"ocm-.*"} > 0 unless on (cluster, namespace, persistentvolumeclaim) kube_persistentvolumeclaim_access_mode{access_mode="ReadOnlyMany",namespace=~"ocm-.*"} == 1 unless on (cluster, namespace, persistentvolumeclaim) kube_persistentvolumeclaim_labels{label_excluded_from_alerts="true",namespace=~"ocm-.*"} == 1'
        for: 'PT1M'
      ...
      }
      {
        ...
        expression: '(kubelet_volume_stats_available_bytes{job="kubelet",metrics_path="/metrics",namespace=~"ocm-.*"} / kubelet_volume_stats_capacity_bytes{job="kubelet",metrics_path="/metrics",namespace=~"ocm-.*"}) < 0.15 and kubelet_volume_stats_used_bytes{job="kubelet",metrics_path="/metrics",namespace=~"ocm-.*"} > 0 and predict_linear(kubelet_volume_stats_available_bytes{job="kubelet",metrics_path="/metrics",namespace=~"ocm-.*"}[6h], 4 * 24 * 3600) < 0 unless on (cluster, namespace, persistentvolumeclaim) kube_persistentvolumeclaim_access_mode{access_mode="ReadOnlyMany",namespace=~"ocm-.*"} == 1 unless on (cluster, namespace, persistentvolumeclaim) kube_persistentvolumeclaim_labels{label_excluded_from_alerts="true",namespace=~"ocm-.*"} == 1'
        for: 'PT1H'
        severity: severityCeiling > 0 ? max(3, severityCeiling) : 3
      }
      {
        ...
        expression: '(kubelet_volume_stats_inodes_free{job="kubelet",metrics_path="/metrics",namespace=~"ocm-.*"} / kubelet_volume_stats_inodes{job="kubelet",metrics_path="/metrics",namespace=~"ocm-.*"}) < 0.03 and kubelet_volume_stats_inodes_used{job="kubelet",metrics_path="/metrics",namespace=~"ocm-.*"} > 0 unless on (cluster, namespace, persistentvolumeclaim) kube_persistentvolumeclaim_access_mode{access_mode="ReadOnlyMany",namespace=~"ocm-.*"} == 1 unless on (cluster, namespace, persistentvolumeclaim) kube_persistentvolumeclaim_labels{label_excluded_from_alerts="true",namespace=~"ocm-.*"} == 1'
        for: 'PT1M'
        severity: severityCeiling > 0 ? max(2, severityCeiling) : 2
      }
      {
        ...
        expression: '(kubelet_volume_stats_inodes_free{job="kubelet",metrics_path="/metrics",namespace=~"ocm-.*"} / kubelet_volume_stats_inodes{job="kubelet",metrics_path="/metrics",namespace=~"ocm-.*"}) < 0.15 and kubelet_volume_stats_inodes_used{job="kubelet",metrics_path="/metrics",namespace=~"ocm-.*"} > 0 and predict_linear(kubelet_volume_stats_inodes_free{job="kubelet",metrics_path="/metrics",namespace=~"ocm-.*"}[6h], 4 * 24 * 3600) < 0 unless on (cluster, namespace, persistentvolumeclaim) kube_persistentvolumeclaim_access_mode{access_mode="ReadOnlyMany",namespace=~"ocm-.*"} == 1 unless on (cluster, namespace, persistentvolumeclaim) kube_persistentvolumeclaim_labels{label_excluded_from_alerts="true",namespace=~"ocm-.*"} == 1'
        for: 'PT1H'
        severity: severityCeiling > 0 ? max(3, severityCeiling) : 3
      }
      {
        ...
        expression: 'kube_persistentvolume_status_phase{job="kube-state-metrics",namespace=~"ocm-.*",phase=~"Failed|Pending"} > 0'
        for: 'PT5M'
        severity: severityCeiling > 0 ? max(2, severityCeiling) : 2
      }
    ]
