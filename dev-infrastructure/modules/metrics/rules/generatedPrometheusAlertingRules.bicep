    ...
    rules: [
      ...
      }
      {
        ...
        annotations: {
          ...
          runbook_url: 'https://eng.ms/docs/cloud-ai-platform/azure-core/azure-cloud-native-and-management-platform/control-plane-bburns/azure-red-hat-openshift/azure-redhat-openshift-team-doc/hcp/troubleshooting/backend-tsg.html'
          summary: 'Orphaned cluster managed resource group detected'
          title: 'Orphaned cluster managed resource group detected resource_group:{{ $labels.resource_group }} subscription_id:{{ $labels.subscription_id }} location:{{ $labels.location }}'
        }
      ...
      }
      {
        ...
        annotations: {
          ...
          title: 'Orphaned cluster managed resource group deletion is failing resource_group:{{ $labels.resource_group }} subscription_id:{{ $labels.subscription_id }} location:{{ $labels.location }}'
        }
