...
Selecting only `swift` does not require deletion-window or pool/zone capacity
settings and does not authorize machine deletion. Adding `never-ready` requires
its explicit window, unavailable limits and healthy floors.
