...
These settings apply only when `--tag=package-2026-10-03-preview` is specified on the command line.

``` yaml $(tag) == 'package-2026-10-03-preview'
input-file:
  - preview/2026-10-03-preview/openapi.json
```
