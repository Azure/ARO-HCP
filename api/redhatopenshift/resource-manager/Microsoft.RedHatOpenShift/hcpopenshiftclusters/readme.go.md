...
batch:
  ...
  - tag: package-2026-10-03-preview
```

### Tag: package-2026-10-03-preview and go

These settings apply only when `--tag=package-2026-10-03-preview --go` is specified on the command line.
Please also specify `--go-sdk-folder=<path to the root directory of your azure-sdk-for-go clone>`.

``` yaml $(tag) == 'package-2026-10-03-preview' && $(go)
output-folder: $(go-sdk-folder)/services/preview/$(namespace)/mgmt/2026-10-03-preview/$(namespace)
```

### Tag: package-2026-10-01-preview and go

These settings apply only when `--tag=package-2026-10-01-preview --go` is specified on the command line.
Please also specify `--go-sdk-folder=<path to the root directory of your azure-sdk-for-go clone>`.

``` yaml $(tag) == 'package-2026-10-01-preview' && $(go)
output-folder: $(go-sdk-folder)/services/preview/$(namespace)/mgmt/2026-10-01-preview/$(namespace)
```
